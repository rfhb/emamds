...
|--------------------------------------------|----------------------------|----------------------------|----------------------------|----------------------------------------------------------------------------------------------------------------------------|
| Change in Hb over the previous 4 weeks 1   | Lower than 10.5            | 10.5 to 11.9               | 12.0 to 12.9               | 13.0 or higher                                                                                                             |
...
| Change in value between -1.0 and +1.0 g/dL | Increase dose by one step  | No change                  | Reduce dose by one step    | Withhold dosing, monitor Hb level and resume dosing when Hb is less than 12.0 g/dL, at a dose that is reduced by two steps |
| Change in value of less than -1.0 g/dL     | Increase dose by one step  | Increase dose by one step  | No change                  | Withhold dosing, monitor Hb level and resume dosing when Hb is less than 12.0 g/dL, at a dose that is reduced by two steps |
...
Roxadustat is not recommended during the first and second trimester of pregnancy (see section 4.4). If pregnancy occurs while Evrenzo is being administered, treatment should be discontinued and switched to alternative treatments, if appropriate (see section 4.3).
...
Pharmacotherapeutic group: anti-anaemic preparations, other anti-anaemic preparations, ATC code: B03XA05.
...
NDD CKD patients Efficacy results Course of Hb during treatment
...
|---------------------------------------------------|---------------------------------------------------|---------------------------------------------------|---------------------------------------------------|---------------------------------------------------|
| Setting                                           | Hb correction                                     | Hb correction                                     | Hb correction                                     | Hb correction                                     |
| Endpoint/ Parameter                               | NDD pool (FAS)                                    | NDD pool (FAS)                                    | DOLOMITES (PPS) 1517-CL-0610                      | DOLOMITES (PPS) 1517-CL-0610                      |
|                                                   | Roxadustat n = 2368                               | Placebo n = 1865                                  | Roxadustat n = 286                                | Darbepoetin alfa n = 273                          |
| Proportion of patients who achieved Hb response 1 | Proportion of patients who achieved Hb response 1 | Proportion of patients who achieved Hb response 1 | Proportion of patients who achieved Hb response 1 | Proportion of patients who achieved Hb response 1 |
| Responders, n (%) [95% CI]                        | 1,899 (80.2) [78.5, 81.8]                         | 163 (8.7) [7.5, 10.1]                             | 256 (89.5) [85.4, 92.8]                           | 213 (78.0) [72.6, 82.8]                           |
| Difference of proportions [95% CI]                | 71.5 [69.40, 73.51]                               | 71.5 [69.40, 73.51]                               | 11.51 [5.66, 17.36]                               | 11.51 [5.66, 17.36]                               |
| Odds ratio [95% CI]                               | 40.49 [33.01, 49.67]                              | 40.49 [33.01, 49.67]                              | 2.48 [1.53, 4.04]                                 | 2.48 [1.53, 4.04]                                 |
| P value                                           | < 0.0001                                          | < 0.0001                                          | ND                                                | ND                                                |
| Change from baseline in Hb (g/dL) 2               | Change from baseline in Hb (g/dL) 2               | Change from baseline in Hb (g/dL) 2               | Change from baseline in Hb (g/dL) 2               | Change from baseline in Hb (g/dL) 2               |
...
| Analysis using ANCOVA                                                | Analysis using ANCOVA                                                | Analysis using ANCOVA                                                | Analysis using ANCOVA                                                | Analysis using ANCOVA                                                |
| LS mean                                                              | -0.446                                                               | 0.066                                                                | -0.356                                                               | 0.047                                                                |
| 95% CI                                                               | -0.484, -0.409                                                       | 0.017, 0.116                                                         | -0.432, -0.280                                                       | -0.033, 0.127                                                        |
| LS mean difference (R-comparator)                                    | -0.513                                                               | -0.513                                                               | -0.403                                                               | -0.403                                                               |
| 95% CI                                                               | -0.573, -0.453                                                       | -0.573, -0.453                                                       | -0.510, -0.296                                                       | -0.510, -0.296                                                       |
| P value                                                              | < 0.0001                                                             | < 0.0001                                                             | < 0.001                                                              | < 0.001                                                              |

P values presented for the NDD pool are nominal p values.

ANCOVA: analysis of covariance; CI: confidence interval; ESA: erythropoiesis-stimulating agent; FAS: full analysis set; IR: incidence rate (per 100 patient-years at risk); IV: intravenous; LDL: low density lipoprotein; LS: least squares; ND: not done; NDD: non-dialysis-dependent; R: roxadustat; RBC: red blood cell;
...
| Population                                                         | DD CKD patients                                                    | DD CKD patients                                                    | DD CKD patients                                                    | DD CKD patients                                                    |
|--------------------------------------------------------------------|--------------------------------------------------------------------|--------------------------------------------------------------------|--------------------------------------------------------------------|--------------------------------------------------------------------|
| Intervention                                                       | Correction                                                         | Correction                                                         | Conversion                                                         | Conversion                                                         |
| Endpoint/                                                          | ID DD pool (FAS)                                                   | ID DD pool (FAS)                                                   | Stable DD pool (FAS)                                               | Stable DD pool (FAS)                                               |
| Parameter                                                          | Roxadustat n = 756                                                 | ESA n = 759                                                        | Roxadustat n = 1586                                                | ESA n = 1589                                                       |
| Mean monthly IV iron over weeks 28 - 52 (mg) 1                     | Mean monthly IV iron over weeks 28 - 52 (mg) 1                     | Mean monthly IV iron over weeks 28 - 52 (mg) 1                     | Mean monthly IV iron over weeks 28 - 52 (mg) 1                     | Mean monthly IV iron over weeks 28 - 52 (mg) 1                     |
| n                                                                  | 606                                                                | 621                                                                | 1414                                                               | 1486                                                               |
| Mean (SD)                                                          | 53.57 (143.097)                                                    | 70.22 (173.33)                                                     | 42.45 (229.80)                                                     | 61.99 (148.02)                                                     |
| Change from baseline in LDL cholesterol (mmol/L) to weeks 12 to 28 | Change from baseline in LDL cholesterol (mmol/L) to weeks 12 to 28 | Change from baseline in LDL cholesterol (mmol/L) to weeks 12 to 28 | Change from baseline in LDL cholesterol (mmol/L) to weeks 12 to 28 | Change from baseline in LDL cholesterol (mmol/L) to weeks 12 to 28 |
| Analysis using ANCOVA                                              | Analysis using ANCOVA                                              | Analysis using ANCOVA                                              | Analysis using ANCOVA                                              | Analysis using ANCOVA                                              |
...
Based on in vitro data , roxadustat is a substrate for CYP2C8 and UGT1A9 enzymes, as well as BCRP, OATP1B1, OAT1 and OAT3. Roxadustat is not a substrate for OATP1B3 or P-gp. Roxadustat is primarily metabolised to hydroxy-roxadustat and roxadustatO -glucuronide. Unchanged roxadustat was the major circulating component in human plasma; no detectable metabolite in human plasma constituted more than 10% of total drug-related material exposure and no human specific metabolites were observed.
...
Evrenzo 20 mg film-coated tablets roxadustat
...
12x1 film-coated tablets

36x1 film-coated tablets
...
EU/1/21/1574/001    12 film-coated tablets

EU/1/21/1574/006    36 film-coated tablets
...
Evrenzo 20 mg tablets roxadustat
...
Evrenzo 50 mg film-coated tablets roxadustat
...
EU/1/21/1574/002    12 film-coated tablets

EU/1/21/1574/007    36 film-coated tablets
...
Evrenzo 50 mg tablets roxadustat
...
Evrenzo 70 mg film-coated tablets roxadustat
...
EU/1/21/1574/003    12 film-coated tablets
...
Evrenzo 70 mg tablets roxadustat
...
Evrenzo 100 mg film-coated tablets roxadustat
...
EU/1/21/1574/004    12 film-coated tablets
...
Evrenzo 100 mg tablets roxadustat
...
Evrenzo 150 mg film-coated tablets roxadustat
...
EU/1/21/1574/005    12 film-coated tablets
