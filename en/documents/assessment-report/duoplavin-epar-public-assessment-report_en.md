...
document_pages: 37
document_pathfilename: www.ema.europa.eu/en/documents/assessment-report/duoplavin-epar-public-assessment-report_en.pdf
document_name: duoplavin-epar-public-assessment-report_en.pdf
version: success
processing_time: 23.3312268
conversion_datetime: 2025-12-19 06:34:18.781885
docling_version:
  docling-serve: 1.9.0
...
## CHMP ASSESSMENT REPORT FOR DuoPlavin
...
Rapporteur: Cristina Sampaio Co-Rapporteur: Pieter Neels
...
This dossier applies for marketing authorization for DuoPlavin, which contains a fixed-dose combination of  clopidogrel  (75  mg)  and  acetylsalicylic  acid  (ASA)  (75  mg  or  100  mg)  as  film-coated  immediaterelease tablet formulations.
...
The synergistic overpotentiation obtained when ASA and clopidogrel are given in combination has been demonstrated in some studies, 3 of which are referred in the DuoPlavin file 123 .  The  observed  additive
...
Studies  in  rats  have  shown  that  clopidogrel  and/or  its  metabolites  are  excreted  in  the  milk  and  breastfeeding should not be continued during treatment with DuoPlavin.
...
Mean± SD (CV%) [Geometric Mean]of ASApharmacokinetic parameters

| PK Parameter     | Combination tablet (n=117)   | Separated tablets (n=117)   |
|------------------|------------------------------|-----------------------------|
| (ng/mL)          | 1580 ± 497 (31) [1500]       | 1230 ± 425 (35) [1160]      |
| tmas (h)         | 0.50 0.50                    | 0.50 0.50                   |
| tiast            | (0.17.1.50)                  | (0.17.2.50) 4.00            |
| (b)              | 4.00 (3.00 23.00)            | (3.00 23.00)                |
| t12z* (h)        | 0.419 0.0895 (21) [0.411]    | 0.428 ± 0.139 (32) [0.415]  |
| AUCast (h.ng/mL) | 1440 干 341 (24) [1400]       | 1310 288 (22) [1280]        |
| AUC*             | 1440 343                     | 1300 290                    |
|                  | (24) [1400]                  | (22) [1270]                 |
| (h.ng/mL)        |                              |                             |

Tabulated values are Mean ± SD (CV%) [Geometric Mean] except for tmax and tlast where values are Median (Min, Max)

* r=116 for combination tablet and n=1 11 for separated tablets

## Pointestimatesand 90%ClsforASAcombinationtablet/separate tablets(n=121)

| Parameter   | Comparison                              |   Estimate | 90% CI       |
|-------------|-----------------------------------------|------------|--------------|
| Cmax        | Combination tabletvs.separated tablets  |        1.3 | (1.22; 1.39) |
| AUC         | Combination tabletvs.separated tablets  |        1.1 | (1.07; 1.13) |
...
Therapeutic  experience  is  limited  in  patients  with  moderate  hepatic  disease  who  may  have  bleeding diatheses. DuoPlavin should therefore be used with caution in this population. DuoPlavin must not be used in patients with severe hepatic impairment. (SPC Sections 4.2, 4.3 and 4.4)
...
(from Plavix supportive studies and from published studies in animals, men and in vitro models). As there is no evidence to suggest a possible negative interaction between clopidogrel and ASA, and both drugs have been extensively used in humans in monotherapy or in combination for a long period and the safety of this combination is well documented, nonclinical studies with the clopidogrel/ASA combination are not considered necessary.
...
The applicant has provided the results of the User Testing concerning the PIL for DuoPlavin, aiming at ensuring  that  the  information  is  legible,  clear  and  easy  to  use  so  that  patients  can  locate  important information within the package leaflet, understand it and act appropriately.
...
- The key messages for safe use of DuoPlavin have been identified and the questions reflect the key messages.
