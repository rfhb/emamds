...
| Infections and infestations                     | Endocarditis               | Not known   |
| Infections and infestations                     | Furuncle                   | Not known   |
| Infections and infestations                     | Staphylococcal infection   | Not known   |
| Immune system disorders                         | Hypersensitivity (1)       | Common      |
| Immune system disorders                         | Anaphylactoid reaction (1) | Common      |
...
| Psychiatric disorders                           | Initial insomnia           | Common      |
| Psychiatric disorders                           | Agitation                  | Not known   |
...
| Eye disorders                                   | Lacrimation increased      | Not known   |
| Ear and labyrinth disorders                     | Deafness                   | Not known   |
| Cardiac disorders                               | Cyanosis (1)               | Common      |
| Cardiac disorders                               | Bradycardia                | Common      |
| Cardiac disorders                               | Aortic valve incompetence  | Not known   |
| Cardiac disorders                               | Palpitations               | Not known   |
...
| Gastrointestinal disorders                      | Vomiting (1)               | Common      |
| Gastrointestinal disorders                      | Abdominal pain upper       | Common      |
| Gastrointestinal disorders                      | Nausea (1 )                | Common      |
...
| Musculoskeletal and connective tissue disorders     | Joint swelling            | Not known   |
| Musculoskeletal and connective tissue disorders     | Joint warmth              | Not known   |
| Renal and urinary disorders                         | Renal failure acute (2)   | Common      |
| General disorder and administration site conditions | Pyrexia (1)               | Very common |
| General disorder and administration site conditions | Chills (1)                | Common      |
| General disorder and administration site conditions | Catheter site pain        | Common      |
| General disorder and administration site conditions | Feeling hot (1)           | Common      |
| General disorder and administration site conditions | Fatigue                   | Common      |
| General disorder and administration site conditions | Malaise (1)               | Common      |
| General disorder and administration site conditions | Asthenia                  | Not known   |
| Investigations                                      | Weight increase           | Very common |
| Injury, poisoning and procedural complications      | Procedural headache       | Common      |
| Injury, poisoning and procedural complications      | Infusion related reaction | Not known   |
...
| Serum oligosaccharide c oncentration (μmol/l) | Serum oligosaccharide c oncentration (μmol/l)        | Serum oligosaccharide c oncentration (μmol/l)        | Serum oligosaccharide c oncentration (μmol/l) | Serum oligosaccharide c oncentration (μmol/l) | Serum oligosaccharide c oncentration (μmol/l) |
| Overall (1) [95% CI] p-value                  | 6.8 (1.2)                                            | -5.11 [-5.66; -4.56]                                 | 6.6 (1.9)                                     | -1.61 [-2.28; -0.94]                          | -3.50 [-4.37; -2.62] p<0.001                  |
| <18 years (2)                                 | 7.3 (1.1)                                            | -5.2 (1.5)                                           | 6.0 (2.4)                                     | -0.8 (1.7)                                    | -                                             |
| ≥ 18 years (2)                                | 6.3 (1.1)                                            | -5.1 (1.0)                                           | 7.2 (1.0)                                     | -2.4 (1.4)                                    |                                               |
| 3MSCT (steps/min)                             | 3MSCT (steps/min)                                    | 3MSCT (steps/min)                                    | 3MSCT (steps/min)                             | 3MSCT (steps/min)                             | 3MSCT (steps/min)                             |
...
Disodium phosphate dihydrate Sodium dihydrogen phosphate dihydrate Mannitol (E 421) Glycine
...
Store and transport refrigerated (2°C - 8°C). Do not freeze. Store in the original package in order to protect from light. For storage conditions after reconstitution of the medicinal product, see section 6.3.
...
EU/1/17/1258/001 EU/1/17/1258/002
...
Prior to the use of Lamzede in each Member State in the home setting the MAH must agree about the content and format of the educational programme, including communication media, distribution modalities, and any other aspects of the programme, with the National Competent Authority. The MAH shall ensure that in each Member State where Lamzede is marketed, all Healthcare Professionals (HCP) who are expected to prescribe Lamzede are provided with the following

<div style=\"page-break-after: always\"></div>

educational pack which includes 'A Guide for Healthcare Professionals Treating Patients with AlphaMannosidosis (HCP guide)'.
...
In order to minimise the risk of hypersensitivity reactions and medication errors in the home infusion setting, the HCP's guide contains the following key safety information to support HCPs (prescribing and/or administering Lamzede) in the management of patients receiving Lamzede in the home setting:

## Information for HCPs prescribing LAMZEDE:

- Information on the risk of medication errors potentially related to the use of Lamzede in the home setting,
- Criteria to determine eligibility for home infusion,
- Information on the need to provide the patients material to all patients receiving home infusions of Lamzede.

## Information for HCPs administering LAMZEDE:

- Information on the risk of medication errors potentially related to the use of Lamzede in the home setting with focus on the actions needed to prevent medication errors that may occur in the home setting,
...
- Information on the preparation and administration of Lamzede infusion,
- Information on the need to provide the patients material to all patients receiving home infusions of Lamzede.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| In order to obtain long-term data on effectiveness and safety of treatment with Lamzede and to characterize the entire alpha-mannosidosis population, including variability of clinical manifestation, progression and natural history, the MAHis requested to submit the results of a study based on adequate source of data deriving from a registry of patients with alpha-mannosidosis. | Annual reports to be submitted as part of the annual re- assessment |
...
After reconstitution, the medicine should be used immediately. If not used immediately, the reconstituted solution should be stored in a refrigerator for no longer than 24 hours.
...
Lamzede 10 mg powder for solution for infusion velmanase alfa Intravenous use
...
- -Your doctor may decide to keep you under observation for one hour or longer after the infusion in relation to the infusion related reactions.
...
It is not known whether velmanase alfa passes into breast milk. Lamzede can be used during breastfeeding since the velmanase alfa will not be absorbed by a breastfed child.
...
Lamzede is only used under the supervision of a doctor who is knowledgeable in the treatment of Alpha Mannosidosis disease. Your doctor may advice that you can be treated at home provided you meet certain criteria. Please contact your doctor if you would like to be treated at home.
...
- -The other ingredients are: disodium phosphate dihydrate, sodium dihydrogen phosphate dihydrate (see section 2 'Lamzede contains sodium'), mannitol (E 421) and glycine.
