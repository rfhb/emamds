...
Ranluspec is indicated in adults for:
...
If, in the physician's opinion, visual and anatomical parameters indicate that the patient is not benefiting from continued treatment, Ranluspec should be discontinued.
...
The safety and efficacy of Ranluspec in children and adolescents below 18 years of age have not been established. Available data in adolescent patients aged 12 to 17 years with visual impairment due to CNV are described in section 5.1 but no recommendation on a posology can be made.
...
## Ranluspec contains polysorbate 20
...
Ranluspec is a biosimilar medicinal product. Detailed information is available on the website of the European Medicines Agency https://www.ema.europa.eu/en.
...
To prepare Ranluspec for intravitreal administration to adults , please adhere to the following instructions:
...
Ranluspec 10 mg/mL solution for injection in pre-filled syringe
...
The safety and efficacy of Ranluspec in children and adolescents below 18 years of age have not been established. Available data in adolescent patients aged 12 to 17 years with visual impairment due to CNV are described in section 5.1.
...
To prepare Ranluspec for intravitreal administration, please adhere to the instructions for use.
...
- How to prepare for Ranluspec treatment
- What are the steps following treatment with Ranluspec
...
Ranluspec 10 mg/mL solution for injection ranibizumab Intravitreal use
...
Ranluspec 10 mg/mL solution for injection in pre-filled syringe ranibizumab
...
Ranluspec 10 mg/mL solution for injection in pre-filled syringe ranibizumab Intravitreal use
...
1. What Ranluspec is and what it is used for
2. What you need to know before you are given Ranluspec
3. How Ranluspec is given
4. Possible side effects
5. How to store Ranluspec
...
Ranluspec is used in adults to treat several eye diseases causing vision impairment.
...
## You must not receive Ranluspec
...
## Before stopping Ranluspec treatment

If you are considering stopping Ranluspec treatment, please go to your next appointment and discuss this with your doctor. Your doctor will advise you and decide how long you should be treated with Ranluspec.
...
## What Ranluspec looks like and contents of the pack

Ranluspec is a solution for injection in a vial (0.23 mL). The solution is clear to slightly opalescent, colourless to pale brownish and aqueous.

Ranluspec is available as a pack containing one glass vial of ranibizumab with chlorobutyl rubber stopper. The vial is for single use only.
...
Please also refer to section 3 'How Ranluspec is given'.

## How to prepare and administer Ranluspec

Single-use vial for intravitreal use only

Ranluspec must be administered by a qualified ophthalmologist experienced in intravitreal injections.

In wet AMD, in CNV, in PDR and in visual impairment due to DME or to macular oedema secondary to RVO the recommended dose for Ranluspec is 0.5 mg given as a single intravitreal injection. This corresponds to an injection volume of 0.05 mL. The interval between two doses injected into the same eye should be at least four weeks.
...
These medical devices are not included within the Ranluspec pack.

To prepare Ranluspec for intravitreal administration to adult patients, please adhere to the following instructions:
...
Detailed instructions for use are given at the end of the leaflet under 'How to prepare and administer Ranluspec'.
...
Ranluspec is a solution for injection in a pre-filled syringe. The pre-filled syringe contains 0.165 mL of a sterile, clear to slightly opalescent, colourless to pale brownish and aqueous solution. The prefilled syringe contains more than the recommended dose of 0.5 mg. The extractable volume is not to be used in total. The excess volume should be expelled prior to injection. Injecting the entire volume of the pre-filled syringe could result in overdose.
