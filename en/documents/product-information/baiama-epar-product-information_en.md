...
Baiama 40 mg/mL solution for injection in pre-filled syringe.
...
Baiama is for intravitreal injection only.

Baiama must only be administered by a qualified physician experienced in administering intravitreal injections.
...
The recommended dose for Baiama is 2 mg aflibercept, equivalent to 0.05 mL.

Baiama treatment is initiated with one injection per month for three consecutive doses. The treatment interval is then extended to two months.
...
The recommended dose for Baiama is 2 mg aflibercept equivalent to 0.05 mL. After the initial injection, treatment is given monthly. The interval between two doses should not be shorter than one month.

If visual and anatomic outcomes indicate that the patient is not benefiting from continued treatment, Baiama should be discontinued.
...
Baiama treatment is initiated with one injection per month for five consecutive doses, followed by one injection every two months.
...
The recommended dose for Baiama is a single intravitreal injection of 2 mg aflibercept equivalent to 0.05 mL.
...
Available data do not suggest a need for a dose adjustment with Baiama in these patients (see section 5.2).
...
The safety and efficacy of Baiama have not been established in children and adolescents below 18 years of age. There is no relevant use of aflibercept in the paediatric population for the indications of wet AMD, CRVO, BRVO, DME and myopic CNV.
...
The pre-filled syringe contains more than the recommended dose of 2 mg aflibercept (equivalent to 0.05 mL). The excess volume must be discarded prior to administration (see sections 4.2 and 6.6).
...
As this is a therapeutic protein, there is a potential for immunogenicity with Baiama (see section 4.8). Patients should be instructed to report any signs or symptoms of intraocular inflammation, e.g. pain, photophobia, or redness, which may be a clinical sign attributable to hypersensitivity.
...
This medicine contains 0.015 mg of polysorbate 20 in each administered dose of 0.05 mL which is equivalent to 0.3 mg/mL. Polysorbates may cause allergic reactions.
...
As with all therapeutic proteins, there is a potential for immunogenicity with Baiama.
...
Baiama is a biosimilar medicinal product. Detailed information is available on the website of the European Medicines Agency https://www.ema.europa.eu.
...
A ≥ 2 step improvement in DRSS was assessed in a pre-specified manner in VIVID DME and VISTA DME . The DRSS score was gradable in 73.7% of the patients in VIVID DME and 98.3% of the patients in VISTA DME . At week 52, 27.7% and 29.1% of the aflibercept 2Q8 groups, and 7.5% and

<div style=\"page-break-after: always\"></div>

14.3% of the control groups experienced a ≥ 2 step improvement in the DRSS. At week 100, the respective percentages were 32.6% and 37.1% of the aflibercept 2Q8 groups and 8.2% and 15.6% of the control groups.
...
|                                                                          | Aflibercept 2 mg Q4 (N= 91)   | Active Control (laser) (N= 90) | Aflibercept 2 mg Q8 (N= 91) D) | Active Control (laser) /Aflibercept 2mg E) (N= 90) |
...
| Efficacy Outcomes                                                     | VIVIDDME                        | VIVIDDME                      | VIVIDDME                         | VIVIDDME                        | VIVIDDME                      | VIVIDDME                         | VISTADME                        | VISTADME                      | VISTADME                         | VISTADME                        | VISTADME                      | VISTADME                         |
|-----------------------------------------------------------------------|---------------------------------|-------------------------------|----------------------------------|---------------------------------|-------------------------------|----------------------------------|---------------------------------|-------------------------------|----------------------------------|---------------------------------|-------------------------------|----------------------------------|
...
| Differenc e in LS mean B,C,E (97.5% CI)                               | 9.1 (6.3, 11.8)                 | 9.3 (6.5, 12.0)               |                                  | 8.2 (5.2, 11.3)                 | 10.7 (7.6, 13.8)              |                                  | 10.45 (7.7, 13.2)               | 12.19 (9.4, 15.0)             |                                  | 10.1 (7.0, 13.3)                | 10.6 (7.1, 14.2)              |                                  |
...
Polysorbate 20 (E 432) Histidine hydrochloride monohydrate (for pH adjustment) Histidine (for pH adjustment) Sodium chloride Sucrose Water for injections
...
Solution in a pre-filled syringe (cyclic olefin polymer) marked with a dosing line, with a plunger stopper (chlorobutyl rubber) and a Luer lock adaptor with a syringe cap (chlorobutyl rubber). Each pre-filled syringe contains an extractable volume of at least 0.09 mL. Pack size of 1 pre-filled syringe.
...
For the intravitreal injection, a 30 G x ½ inch injection needle should be used. This medical device is not included within this pack.
...
1. When ready to administer Baiama, open the carton and remove the sterilised blister. Carefully peel open the blister ensuring the sterility of its contents. Keep the syringe in the sterile tray until you are ready for assembly.
...
7. The excess volume must be discarded prior to administration. Eliminate all bubbles and expel excess medicinal product by slowly depressing the plunger to align the edge of the plunger dome (not the tip of the dome) with the dosing line on the syringe (equivalent to 0.05 mL i.e. 2 mg aflibercept).
...
Date of first authorisation: 13 January 2025
...
Baiama 40 mg/mL solution for injection in a vial.
...
The vial contains more than the recommended dose of 2 mg aflibercept (equivalent to 0.05 mL solution for injection). The extractable volume of the vial is the amount that can be withdrawn from the vial and is not to be used in total. For the Baiama vial, the extractable volume is at least 0.1 mL. The excess volume must be expelled before injecting the recommended dose (see section 6.6).
...
Solution in a vial (type I glass) with a stopper (elastomeric butyl rubber). Each vial contains an extractable volume of at least 0.1 mL. Pack size of 1 vial.
...
3. Push the filter needle into the center of the vial stopper until the needle is completely inserted into the vial and the tip touches the bottom or the bottom edge of the vial.
4. Using aseptic technique withdraw all of the Baiama vial contents into the syringe, keeping the vial in an upright position, slightly inclined to ease complete withdrawal. To deter the introduction of air, ensure the bevel of the filter needle is submerged into the liquid. Continue to tilt the vial during withdrawal keeping the bevel of the filter needle submerged in the liquid:
...
AGC Biologics, Inc. 21511 23 rd Dr. SE, Bothell Washington (WA) 98021 USA
...
- Confirmation that the vial and the pre-filled syringe are for single use in adults only
...
Baiama 40 mg/mL solution for injection in pre-filled syringe aflibercept
...
Excipients: Polysorbate 20 (E 432), histidine hydrochloride monohydrate, histidine, sodium chloride, sucrose, water for injections.
...
Baiama 40 mg/mL solution for injection in pre-filled syringe aflibercept Intravitreal use
...
Baiama 40 mg/mL injection aflibercept Intravitreal use
...
Baiama 40 mg/mL solution for injection in a vial aflibercept
...
## Baiama 40 mg/mL solution for injection in a pre-filled syringe
...
2. What you need to know before you are given Baiama
3. How you will be given Baiama
...
If any of the above applies to you, your doctor will consider this lack of information when treating you with Baiama.
...
After your injection with Baiama, you may experience some temporary visual disturbances. Do not drive or use machines as long as these last.

## Baiama contains polysorbate and sodium

Baiama contains polysorbate 20 (E 432) and sodium chloride.
...
A doctor experienced in giving eye injections will inject Baiama into your eye under aseptic (clean and sterile) conditions.

The recommended dose is 2 mg aflibercept (0.05 mL). Baiama is given as an injection into your eye (intravitreal injection).
...
Your doctor will determine the most appropriate treatment schedule for you. You will start your treatment with a series of monthly Baiama injections.

The interval between two injections should not be shorter than one month.

Your doctor may decide to stop treatment with Baiama, if you are not benefiting from continued treatment.
...
Your doctor may decide to stop treatment with Baiama if it is determined that you are not benefiting from continued treatment.
...
Detailed instructions for use are given at the end of the leaflet under 'How to prepare and administer Baiama'.

## If a dose of Baiama is missed

Make a new appointment for an examination and injection.

## Stopping treatment with Baiama
...
As with all therapeutic proteins, there is a possibility for an immune reaction (formation of antibodies) with Baiama.
...
Baiama is a solution for injection (injection) in a pre-filled syringe. The solution is colourless to pale yellow.
...
Baiama is a solution for injection (injection) in a vial. The solution is colourless to pale yellow. Pack size of 1 vial.
...
2. Attach a 18 G, 5-micron filter needle to a 1 mL sterile, Luer-lock syringe:
3. Push the filter needle into the center of the vial stopper until the needle is completely inserted into the vial and the tip touches the bottom or the bottom edge of the vial.
4. Using aseptic technique withdraw all of the Baiama vial contents into the syringe, keeping the vial in an upright position, slightly inclined to ease complete withdrawal. To deter the introduction of air, ensure the bevel of the filter needle is submerged into the liquid. Continue to
