...
Clear, colourless, free from visible particles, solution for injection.
...
Sodium acetate trihydrate Glacial acetic acid Sorbitol (E420) Polysorbate 20 Water for injections
...
Nyvepria 6 mg solution for injection pegfilgrastim
...
Excipients: sodium acetate trihydrate, glacial acetic acid, sorbitol (E420), polysorbate 20, water for injections. See the package leaflet for further information.
...
## PARTICULARS TO APPEAR ON UNIT SYRINGE CARTON

## UNIT SYRINGE CARTON WITH SYRINGE WITH AUTOMATIC NEEDLE GUARD
...
-  Do not remove the peelable label on the pre-filled syringe barrel before injecting the medicine.
...
For a more comfortable injection, leave the pre-filled syringe at room temperature (not above 25°C) for about 30 minutes before injecting. Wash your hands thoroughly with soap and water.

On a clean, well-lit work surface, place the new pre-filled syringe and the other supplies.

-  Do not warm the syringe by using a heat source such as hot water or microwave.
...
- Outer area of upper arm (only if someone else is giving you the injection). Clean the injection site with an alcohol wipe. Let your skin dry.
...
## C When the syringe is empty, LIFT the syringe off skin.

<!-- image -->

After releasing the plunger rod, the pre-filled syringe automatic needle guard will safely cover the injection needle.

<!-- image -->

-  Do not put the needle cover back on used pre-filled syringes.

<!-- image -->

When you remove the syringe, if it looks like the medicine is still in the syringe barrel, this means you have not received a full dose. Call your doctor or healthcare provider right away.
