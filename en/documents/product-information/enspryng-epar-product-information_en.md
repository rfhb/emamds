---
document_datetime: 2026-08-21 11:33:22
document_pages: 64
...
version: success
processing_time: 17.0792659
conversion_datetime: 2026-08-23 00:30:32.286031
docling_version:
...
Enspryng 120 mg solution for injection in pre-filled syringe Enspryng 120 mg solution for injection in pre-filled pen

## 2. QUALITATIVE AND QUANTITATIVE COMPOSITION

Enspryng 120 mg solution for injection in pre-filled syringe

Each pre-filled syringe contains 120 mg of satralizumab in 1 mL (120 mg/mL).

Enspryng 120 mg solution for injection in pre-filled pen

Each pre-filled pen contains 120 mg of satralizumab in 1 mL (120 mg/mL).
...
Enspryng can be used as a monotherapy or in combination with oral corticosteroids (OCs), azathioprine (AZA) or mycophenolate mofetil (MMF) (see section 5.1). The posology in adolescent patients ≥12 years of age with body weight ≥ 40 kg and adult patients i s the same.
...
If the neutrophil count is below 1.0 x 10 9 /L and confirmed by repeat testing, treatment should be interrupted until the neutrophil count is &gt;1.0 x 10 9 /L.
...
Satralizumab 120 mg is administered by subcutaneous injection using a single-dose pre-filled syringe or pre-filled pen. The total content (1 mL) of the pre-filled syringe or pre-filled pen should be administered.

<div style=\"page-break-after: always\"></div>

The recommended injection sites are the thighs and abdomen , at least 5 cm away from the navel. Injection sites should be rotated and at least 5 cm away from the most recent injection site. Injections should never be given into moles, scars, or areas where the skin is tender, bruised, red, hard, or not intact.
...
9.6% of patients receiving satralizumab had neutrophils below 1 x 10 9 /L, compared with 5.4% receiving placebo (or placebo plus IST).

## Platelets

In the double-blinded treatment period, decreases in platelet count (below 150 × 10 9 /l) occurred in 24.0% of patients on satralizumab (monotherapy or in combination with IST) as compared with 9.5% of patients receiving placebo or placebo plus IST. The decreased platelet count was not associated with bleeding events.

The majority of the decreased platelets were transient and not below 75 × 10 9 /l.
...
| Study name                                                         | Study BN40898 (AQP4-IgG seropositive: N=55; ITT*: N=83 )                                                                                                                                                                     | Study BN40898 (AQP4-IgG seropositive: N=55; ITT*: N=83 )                                                                                                                                                                     |
|--------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Study design                                                       | Study design                                                                                                                                                                                                                 | Study design                                                                                                                                                                                                                 |
| Study population                                                   | Adolescent and adult patients with NMO or NMOSD, treated with stable IST Age 12-74 years, ≥ 2 relapses in the last 2 years prior screening (with at least one relapse in the 12 months prior to screening), EDSS of 0 to 6.5 | Adolescent and adult patients with NMO or NMOSD, treated with stable IST Age 12-74 years, ≥ 2 relapses in the last 2 years prior screening (with at least one relapse in the 12 months prior to screening), EDSS of 0 to 6.5 |
...
| Study name                                                 | Study BN40900 (AQP4-IgG seropositive: N=64; ITT*: N=95)                                                                                                                                                                                                      | Study BN40900 (AQP4-IgG seropositive: N=64; ITT*: N=95)                                                                                                                                                                                                      |
|------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Study design                                               | Study design                                                                                                                                                                                                                                                 | Study design                                                                                                                                                                                                                                                 |
| Study population                                           | Adult patients with NMO or NMOSD Age 18-74 years, ≥ 1 relapse or first attack in the last 12 months prior to screening, EDSS of 0 to 6.5. Patients either received prior relapse prevention treatment for NMOSD or were treatment naïve                      | Adult patients with NMO or NMOSD Age 18-74 years, ≥ 1 relapse or first attack in the last 12 months prior to screening, EDSS of 0 to 6.5. Patients either received prior relapse prevention treatment for NMOSD or were treatment naïve                      |
...
Treatment with satralizumab in AQP4-IgG seropositive patients reduced the annualised rate of adjudicated relapses (ARR) by 88% (rate ratio [RR]=0.122, 95% CI: 0.027 - 0.546; p=0.0039) in study BN40898 and 90% (RR=0.096, 95% CI: 0.020 - 0.473; p= 0.0086) in study BN40900 compared to treatment with placebo.
...
The pharmacokinetics of satralizumab following administration by pre-filled syringe or pre-filled pen were comparable.
...
Do not freeze. Do not use the pre-filled syringe or pre-filled pen if it has been frozen. Always keep the pre-filled syringe or pre-filled pen dry.

Store in the outer carton in order to protect from light and moisture.

If unopened and kept in the outer carton, the pre-filled syringe or pre-filled pen may be left out of the refrigerator below 30°C for a single period up to 8 days. After storage at room temperature the product should not be returned to the refrigerator and should be either used or discarded.
...
1mL solution in a pre-filled syringe (polymer) with a staked-in, stainless steel needle, fitted with a chlorinated butyl rubber-polypropylene rigid needle shield and sealed with a chlorinated butyl rubber plunger stopper. The pre-filled syringe is assembled with pre-filled pen subassemblies. Pack size of 1 or 3 pre-filled pens. Not all pack sizes may be marketed.

<div style=\"page-break-after: always\"></div>

## 6.6 Special precautions for disposal and other handling

After removing the carton from the refrigerator, the pre-filled syringe or pre-filled pen should be removed from the sealed carton. The pre-filled syringe should be carefully lifted out of the carton by holding the barrel. It is important to let the pre-filled syringe or pre-filled pen reach room temperature by waiting for 30 minutes before initiating the administration process.

The medicinal product should not be used if the liquid is cloudy, discoloured, has visible particles in it or if the pre-filled syringe or pre-filled pen appears to be damaged or has been dropped.

The injection must be performed right after removing the cap and no later than 5 minutes, to prevent the medicinal product from drying out and blocking the needle. If the pre-filled syringe or pre-filled pen is not used within 5 minutes of removing the cap, you must dispose of it in a puncture resistant container and use a new pre-filled syringe or pre-filled pen.

Touching the green needle shield of the pre-filled pen or putting the cap back on after it has been removed should be avoided, as this may lead to unintentional activation of the pre-filled pen. Any unused medicinal product or waste material should be disposed of in accordance with local requirements.
...
EU/1/21/1559/001 EU/1/21/1559/002 EU/1/21/1559/003 EU/1/21/1559/004

## 9. DATE OF FIRST AUTHORISATION/RENEWAL OF THE AUTHORISATION

Date of first authorisation: 24 June 2021 Date of latest renewal: 10 February 2026
...
The patient alert card is aimed at intensifying the communication around the risk of infections/serious infections, to ensure that patients seek early medical attention in case of signs and symptoms of infections to facilitate timely diagnosis of infections, and that the healthcare professionals are aware of the need for timely and appropriate measures.

The MAH shall ensure that in each Member State where Enspryng is marketed, all healthcare professionals and patients/carers who are expected to prescribe, dispense, administer or use Enspryng have access to/are provided with the patient alert card.

The patient alert card contains:

- information that Enspryng treatment may increase the risk of infections
- a warning message on seeking early medical care in case of signs or symptoms of infections
- a warning message for healthcare professionals treating the patient at any time, including in conditions of emergency, that the patient is using Enspryng
- contact details of the Enspryng prescriber
...
Each pre-filled syringe contains 120 mg satralizumab

## 3. LIST OF EXCIPIENTS

Excipients: histidine, aspartic acid, arginine, poloxamer 188, water for injections.
...
EU/1/21/1559/001 1 pre-filled syringe
...
Keep the pre-filled syringe in the outer carton in order to protect from light and moisture If unopened and kept in the outer carton, Enspryng may be left out of the refrigerator below 30°C for a single period up to 8 days
...
Enspryng 120 mg solution for injection in pre-filled pen satralizumab

## 2. STATEMENT OF ACTIVE SUBSTANCE(S)

Each pre-filled pen contains 120 mg satralizumab.
...
Allow the pre-filled pen to sit at room temperature outside the box for 30 minutes before use
...
EU/1/21/1559/003 1 pre-filled pen

EU/1/21/1559/004 3 pre-filled pens
...
In most cases these are mild reactions, but some can be serious. if you have any of these signs during or after the injection,

Tell your doctor or nurse straight away particularly in the first 24 hours after the injection:
...
Before injecting, wait 30 minutes for the syringe to reach room temperature.
...
## Instructions for use of Enspryng pre-filled syringe
...
- 1 pre-filled syringe for one-time use only.
...
- 1 small bandage
- 1 puncture-resistant sharps container for safe disposal of the needle cap and used syringe. See step 21 'Disposing of Enspryng' at the end of these instructions for use.
...
Choose a different injection site for each new injection. Choose a different site for each new injection at least 5 cm away from the place used last time.
...
- The needle will now be covered by the automatic needle-guard. If the needle is not covered, carefully place the syringe into a puncture-resistant sharps container to avoid injury. See step 21 'Disposing of Enspryng'.
...
- Enspryng is given by injection under the skin (sub-cutaneously).
- Inject the entire content of the pen each time.
...
Because Enspryng is in a pre-filled pen, it is unlikely that you will receive too much. However, if you are worried, talk to your doctor, pharmacist or nurse.
...
- redness, itching, pain or swelling where the injection is given
- hardening of the skin where the injection is given
- rash, red or itchy skin or hives
- feeling flushed
- headache
- throat irritation, swelling or pain
...
- Store in a refrigerator (2 °C - 8 °C). Do not freeze. Do not use the pre-filled pen if it has been frozen.
- Always keep the pre-filled pen dry.
- Keep the pre-filled pen in the outer carton in order to protect from light.
- If unopened and kept in the outer carton, Enspryng may be left out of the refrigerator below 30 °C for a single period up to 8 days. Do not return Enspryng to the refrigerator.
- Do not use and discard the pre-filled pen if it has been left out of the refrigerator for longer than 8 days.

Do not use this medicine if it is cloudy, discoloured or contains particles. Enspryng is a colourless to slightly yellow liquid.

Before injecting, wait 30 minutes for the pre-filled pen to reach room temperature.

The medicine must be injected right after removing the cap and no later than 5 minutes to prevent the medicine from drying out and blocking the needle. If the pre-filled pen is not used within 5 minutes of removing the cap, you must dispose of it in a puncture-resistant container and use a new pre-filled pen.

Do not touch the green needle shield of the pre-filled pen or put the cap back on after it has been removed, as this may activate the pre-filled pen before you are ready to inject.
...
- The active substance is satralizumab. Each pre-filled pen contains 120 mg of satralizumab in 1 mL.
- The other ingredients are histidine, aspartic acid, arginine, poloxamer 188, water for injections.
...
- It is a colourless to slightly yellow liquid.
- Enspryng is a solution for injection.
- Each pack of Enspryng contains 1 or 3 pre-filled pens. Not all pack sizes may be marketed.
...
## Instructions for use of Enspryng pre-filled pen

## Read this Instructions for Use:

- Before you start using the Enspryng pre-filled pen.
- Each time you get a new prescription. There may be new information.
- This information does not take the place of talking to your doctor or nurse about your medical condition and treatment.
- Your doctor or nurse will show you or your caregiver how to use Enspryng the right way.
- Talk to your doctor or nurse if you have questions.

## Important information you need to know before injecting Enspryng

- Do not use Enspryng pre-filled pen until your doctor or nurse has trained you or your caregiver on the right way to inject.
- Do not use if the expiry (EXP) date has passed.
- Do not use if the seals on the carton have been broken.
- Do not try to take the pre-filled pen apart at any time.
- Do not remove the cap until you are ready to inject.
- Do not use if the pre-filled pen has been damaged, or dropped.
- Do not touch or clean the green needle shield.
- Do not inject through clothing.

## How should I store Enspryng?

- Store Enspryng pre-filled pen in the original carton in the refrigerator between 2 °C to 8 °C until ready to use.
- If needed, the pre-filled pen can be stored at room temperature up to 30 °C for up to 8 days.
- Keep the pre-filled pen in the original carton away from direct sunlight.
- Do not freeze Enspryng. Do not use the pre-filled pen if it has been frozen.
- Throw away the pre-filled pen if it has been frozen, has been exposed to light or temperatures above 30 °C or has been out of the refrigerator for more than 8 days.
- Keep Enspryng and all medicines out of the reach of children.

## Enspryng pre-filled pen

Always check that you have the right medicine and dose that your doctor prescribed.
...
1. Gather supplies needed for your injection
...
- 1 sterile cotton ball or gauze
- 1 small plaster
- 1 sharps container (see step 17 'Dispose of the pre-filled pen')

## Remove the pre-filled pen

<!-- image -->

2. Take the Enspryng pre-filled pen carton out of the refrigerator.
3. Open the carton and take the pre-filled pen out of the tray.
...
4. Check the expiry (EXP) date on the pre-filled pen.
- Do not inject if the expiry date (EXP) has passed.
5. Check the medicine through the viewing window. The medicine should be clear or slightly yellow. There should be no particles in it.
- Do not inject if the medicine looks cloudy, discoloured, or has particles in it. You may see small air bubbles. This is normal.
6. Check the pre-filled pen for any damage.
- Do not use if the pre-filled pen is cracked or broken.

If the expiry date has passed, the pre-filled pen is damaged or the medicine is cloudy, discoloured or has particles in it, do not use. Safely throw away the pre-filled pen in a sharps container (See Step 17) and contact your doctor or pharmacist.

## Let your pre-filled pen get to room temperature

<!-- image -->

7. Place the pre-filled pen on a clean, flat surface (like a table) for 30 minutes. This allows the medicine to reach room temperature.

If the pre-filled pen does not reach room temperature, it may take longer to inject the medicine. Injecting cold medicine may feel uncomfortable.
...
8. You can inject Enspryng in the stomach area (abdomen) or front of the thigh.
...
Choose a different injection site for each new injection. Each injection must be at least 5 cm away from area where you last injected.
...
10. Clean the injection site with an alcohol pad and let it air dry.
...
11. Hold the pre-filled pen with the cap pointing up. Then pull the cap straight off. The needle will remain hidden.

<div style=\"page-break-after: always\"></div>

Use the pre-filled pen within 5 minutes of removing the cap .

Important: Do not touch the green needle shield. This may cause a needle stick injury.

- Do not clean the green needle shield. This may activate the pre-filled pen.
- Do not put the cap back on after it has been removed. This may activate the pre-filled pen.

## Place onto the skin

<!-- image -->

12. Hold the pre-filled pen, so that you can see the viewing window . Place the pre-filled pen flat against the skin with the green needle shield facing down.

You may see drops of liquid. This is normal.
...
13. Push firmly and hold down the pre-filled pen against the skin. The first click indicates the injection has started.

The green plunger moves down in the viewing window. It might take up to 5 seconds.

- Do not lift the pre-filled pen if the green plunger is moving. This may cause a loss of medicine.
14. Keep holding down the pre-filled pen firmly.

Wait for the second click. This means the injection is done.

If you have trouble hearing the clicks: Watch the green plunger as it moves down. Or check if the green plunger has already filled the entire viewing window (See Step 15).
...
15. Before removing the pre-filled pen from the injection site, check that the green plunger fills the viewing window entirely.

If the green plunger does not fill the viewing window , you may not have received the full dose. Safely throw away the pre-filled pen in a sharps container (See Step 17) and contact your doctor or pharmacist.

## Remove the pre-filled pen

<!-- image -->

16. Remove the pre-filled pen by lifting it straight up from the skin.
...
17. Put the used pre-filled pen and the cap in a sharps disposal container right away after use.
...
18. There may be a small amount of blood or medicine at the injection site.

You can press a cotton ball or gauze on the area.  If needed, cover the injection site with a small plaster.
...
how to throw away medicines you no longer use. This will help protect the environment. When the container is full, make sure you dispose of it as instructed by your doctor, nurse or
