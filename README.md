# Regulatory documents as Markdown documents
...
Source files are obtained at least once a week from the [European Medicines Agency (EMA)](https://www.ema.europa.eu/en/medicines), which is acknowledged as a source of information used here and should always be acknowledged by users.

When using any Markdown file from this repository or offering, please include the citation

> Herold, R. (2026). Regulatory documents as Markdown files \[Data set\]. 
> https://github.com/rfhb/emamds

See <https://regulatorysciencedata.eu/posts/cancermedicineschildren/> for documentation, background and how to contribute.
