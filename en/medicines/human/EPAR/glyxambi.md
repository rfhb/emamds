---
document_datetime: 2025-12-29 12:21:19
document_pages: 1
document_pathfilename: www.ema.europa.eu/en/medicines/human/EPAR/glyxambi.html
document_name: glyxambi.html
version: success
processing_time: 0.1042113
conversion_datetime: 2025-12-30 12:34:49.918957
docling_version:
  docling-serve: 1.9.0
...
- [News on Glyxambi](#news-on)
- [More information on Glyxambi](#related-medicines)
- [Topics](#topics)
...
Glyxambi is available as tablets containing 10 or 25 mg of empagliflozin with 5 mg of linagliptin, and can only be obtained with a prescription. The recommended dose is one tablet once a day. Patients switching from empagliflozin and linagliptin to Glyxambi should receive the strength of Glyxambi that corresponds to the doses of empagliflozin and linagliptin in the separate tablets they were taking.

If Glyxambi is used in combination with insulin or a sulphonylurea, their doses may need to be reduced to decrease the risk of hypoglycaemia (low blood sugar levels). The doctor may need to reduce the dose of Glyxambi or discontinue its use in patients with reduced kidney function.
...
The most common side effects with Glyxambi (which may affect more than 7 in 100 people) are urinary infections. The most serious side effects are ketoacidosis (high blood levels of acids called 'ketoacids'), pancreatitis (inflammation of the pancreas), hypersensitivity (allergic reactions) and hypoglycaemia (low blood sugar levels). For the full list of all side effects reported with Glyxambi, see the package leaflet.

Glyxambi must not be used in people who are hypersensitive (allergic) to empagliflozin, linagliptin, any of the other ingredients or who have ever had a serious allergic reaction to any DPP-4 or SGLT2 inhibitor. For the full list of restrictions, see the package leaflet.
...
The CHMP considered that Glyxambi is effective at controlling blood glucose levels, with both components contributing to the effect. Regarding its safety profile, Glyxambi was well tolerated with side effects being characteristic of SGLT2 and DDP-4 inhibitors.
...
## Other information about Glyxambi

The European Commission granted a marketing authorisation valid throughout the European Union for Glyxambi on 11 November 2016.

For more information about treatment with Glyxambi, read the package leaflet (also part of the EPAR) or contact your doctor or pharmacist.

Glyxambi : EPAR - Summary for the public
...
Glyxambi : EPAR - Risk-management-plan summary

English (EN) (71.1 KB - PDF)

**First published:** 10/12/2019

[View](/en/documents/rmp-summary/glyxambi-epar-risk-management-plan-summary_en.pdf)
...
Glyxambi : EPAR - All Authorised presentations
...
Opinion adopted 15/09/2016 Marketing authorisation issued 11/11/2016 Revision 21
...
Glyxambi : EPAR - Procedural steps taken and scientific information after authorisation (archive)
