...
The concentrate is a clear and colourless to slightly yellow solution with a pH of approximately 5.5 and an osmolarity of approximately 300 mOsm/L.
...
For the posology of the subcutaneous dosing regimen, see section 4.2 of the Summary of Product Characteristics for Omvoh solutions for injection in pre-filled syringe and pre-filled pen. Consideration should be given to discontinuing treatment in patients who have shown no evidence of therapeutic benefit by week 24.
...
|------------------------------------------------------|-------------|---------------------------------------------|
| Infections and infestations                          | Common      | Upper respiratory tract infections a        |
...
| Skin and subcutaneous tissue disorders               | Common      | Rash b                                      |
| General disorders and administration site conditions | Very common | Injection site reactions c                  |
...
No association was found between anti-mirikizumab antibodies and hypersensitivity or injectionrelated events in either the ulcerative colitis or the Crohn's disease studies.
...
The efficacy and safety of mirikizumab was evaluated in adult patients with moderately to severely active ulcerative colitis in two randomised, double-blind, placebo-controlled, multicentre studies.

<div style=\"page-break-after: always\"></div>

Enrolled patients had a confirmed diagnosis of ulcerative colitis for at least 3 months and moderately to severely active disease, defined as a modified Mayo score of 4 to 9, including a Mayo endoscopy subscore ≥ 2. Patients had to have failed (defined as loss of response, inadequate response or intolerance) corticosteroids or immunomodulators (6-mercaptopurine, azathioprine) or at least one biologic (a TNFα antagonist and/or vedolizumab) or tofacitinib.
...
## Recapture of efficacy after loss of response to mirikizumab maintenance (LUCENT-2)
...
|                                                                                                          | Placebo n=199        | Placebo n=199        | Mirikizumab 300 mg SC injection a n=579   | Mirikizumab 300 mg SC injection a n=579   | Treatment Difference from Placebo b (99.5% CI)   |
|----------------------------------------------------------------------------------------------------------|----------------------|----------------------|-------------------------------------------|-------------------------------------------|--------------------------------------------------|
|                                                                                                          | n                    | %                    | n                                         | %                                         |                                                  |
...
- j Endoscopic remission is defined as SESCD Total Score ≤4 and at least a 2 -point reduction versus baseline and no subscore &gt;1 in any individual variable, based on central reading.
...
LS Mean = Least Square Mean; SE = Standard Error; others see above table 4.

- a Weeks 0, 4, 8
- b see table 4. Also see footnote h below.
...
Improvements in clinical remission by CDAI were observed as early as week 4 in a greater proportion of patients treated with mirikizumab compared to placebo. Reductions in abdominal pain were observed as early as week 4 and in stool frequency as early as week 6 in patients treated with mirikizumab compared to placebo.
...
Mean (coefficient of variation in %) Cmax and area under the curve (AUC) after induction dosing (300 mg every 4 weeks administered by intravenous infusion) in patients with ulcerative colitis were 99.7 µg/mL (22.7 %) and 538 µg*day/mL (34.4 %), respectively. The mean (CV %) Cmax and AUC after maintenance dosing (200 mg every 4 weeks by subcutaneous injection) were 10.1 µg/mL (52.1 %) and 160 µg*day/mL (57.6 %), respectively.
...
In patients with ulcerative colitis, population pharmacokinetic analysis showed that creatinine clearance (range of 36.2 to 291 mL/min) or total bilirubin (range of 1.5 to 29 µmol/L) did not affect mirikizumab pharmacokinetics.

In patients with Crohn's disease, population pharmacokinetic analysis showed that creatinine clearance (range of 26.5 to 269 mL/min) or total bilirubin (range of 1.5 to 36 µmol/L) did not affect mirikizumab pharmacokinetics.
...
Keep the diluted solution away from direct heat or light. Do not freeze the diluted solution.

## 6.4 Special precautions for storage

## Unopened vial

Store in a refrigerator (2 ºC - 8 ºC). Do not freeze. Keep the vial in the outer carton in order to protect from light.
...
Omvoh 100 mg solution for injection in pre-filled syringe Omvoh 100 mg solution for injection in pre-filled pen Omvoh 200 mg solution for injection in pre-filled syringe Omvoh 200 mg solution for injection in pre-filled pen

## 2. QUALITATIVE AND QUANTITATIVE COMPOSITION

Omvoh 100 mg solution for injection in pre-filled syringe

Each pre-filled syringe contains 100 mg mirikizumab in 1 mL solution.

Omvoh 100 mg solution for injection in pre-filled pen

Each pre-filled pen contains 100 mg mirikizumab in 1 mL solution.

Omvoh 200 mg solution for injection in pre-filled syringe

Each pre-filled syringe contains 200 mg mirikizumab in 2 mL solution.

Omvoh 200 mg solution for injection in pre-filled pen

Each pre-filled pen contains 200 mg mirikizumab in 2 mL solution.
...
The solution is a clear and colourless to slightly yellow solution with a pH of approximately 5.5 and an osmolarity of approximately 300 mOsm/L.
...
This medicinal product is intended for use under the guidance and supervision of a physician experienced in the diagnosis and treatment of ulcerative colitis or Crohn's disease. Omvoh 100 mg solution for injection and Omvoh 200 mg solution for injection should only be used for the subcutaneous maintenance doses.
...
This medicinal product contains 0.3 mg/mL of polysorbate 80 in each pen or syringe which is equivalent to 0.6 mg for the maintenance dose to treat ulcerative colitis and equivalent to 0.9 mg for the maintenance dose to treat Crohn's disease.  Polysorbates may cause allergic reactions.
...
Following subcutaneous dosing of mirikizumab for ulcerative colitis, median (range) Tmax was 5 (3.08-6.75) days post dose and geometric mean (CV%) absolute bioavailability of 44 % (34 %). Following subcutaneous dosing of mirikizumab for Crohn's disease, median (range) Tmax was 5 (3 to 6.83) days post dose and geometric mean (CV%) absolute bioavailability was 36.3% (31%).
...
Omvoh may be stored unrefrigerated for up to 2 weeks at a temperature not above 30 ºC. If these conditions are exceeded, Omvoh must be discarded.
...
- packs of 2 pre-filled syringes
- multipacks containing 6 (3 packs of 2) pre-filled syringes.
...
- packs of 2 pre-filled pens
- multipacks containing 4 (2 packs of 2) pre-filled pens
- multipacks containing 6 (3 packs of 2) pre-filled pens.
...
## Omvoh 100 mg solution for injection in pre-filled pen and 200 mg solution for injection in pre-filled pen

Pre-filled pens with 1 mL and 2 mL solution in a type I clear glass syringe. Each syringe is encased in a disposable, single-dose pen with bromobutyl rubber plunger.

Pack sizes:

- Packs of 2 pre-filled pens (1 pre-filled pen of 100 mg and 1 pre-filled pen of 200 mg)
- Multipacks containing 6 pre-filled pens (3 packs of 1 pre-filled pen of 100 mg and 1 pre-filled pen of 200 mg each).

Not all pack sizes may be marketed.

## 6.6 Special precautions for disposal and other handling

For single use only. Omvoh should not be used if particles appear or if the solution is cloudy and/or distinctly brown.
...
Omvoh 100 mg solution for injection in pre-filled pen and Omvoh 200 mg solution for injection in pre-filled pen
...
Pre-filled pen, Pre-filled syringe, Vial (1 pack) Lilly France S.A.S., Rue du Colonel Lilly, 67640 Fegersheim, France
...
OUTER CARTON FOR VIAL MULTIPACK (with Blue Box)
...
## INTERMEDIATE CARTON OF VIAL MULTIPACK (without Blue Box)
...
Omvoh 300 mg sterile concentrate mirikizumab For IV use after dilution
...
OUTER CARTON - PRE-FILLED SYRINGE (pack of 2)

## 1. NAME OF THE MEDICINAL PRODUCT

Omvoh 100 mg solution for injection in pre-filled syringe mirikizumab

## 2. STATEMENT OF ACTIVE SUBSTANCE(S)

Each pre-filled syringe contains 100 mg of mirikizumab in 1 mL solution.

## 3. LIST OF EXCIPIENTS

Excipients: histidine; histidine monohydrochloride; sodium chloride; mannitol (E 421); polysorbate 80 (E 433); water for injections. See leaflet for further information.

## 4. PHARMACEUTICAL FORM AND CONTENTS

## Solution for injection

2 pre-filled syringes of 100 mg
...
Excipients: histidine; histidine monohydrochloride; sodium chloride; mannitol (E421); polysorbate 80 (E 433); water for injections. See leaflet for further information.

## 4. PHARMACEUTICAL FORM AND CONTENTS

## Solution for injection

2 pre-filled syringes of 100 mg. Component of a multipack, can't be sold separately.
...
OUTER CARTON - PRE-FILLED SYRINGE (pack of 1)

## 1. NAME OF THE MEDICINAL PRODUCT

Omvoh 200 mg solution for injection in pre-filled syringe mirikizumab

## 2. STATEMENT OF ACTIVE SUBSTANCE(S)

Each pre-filled syringe contains 200 mg of mirikizumab in 2 mL solution.
...
1 pre-filled syringe of 200 mg
...
1 pre-filled syringe of 200 mg. Component of a multipack, can't be sold separately.
...
Each pre-filled syringe of 1 mL solution contains 100 mg of mirikizumab.

Each pre-filled syringe of 2 mL solution contains 200 mg of mirikizumab.
...
1 pre-filled syringe of 100 mg and 1 pre-filled syringe of 200 mg
...
Multipack: 6 pre-filled syringes (3 packs each containing 1 pre-filled syringe of 100 mg and 1 pre-filled syringe of 200 mg)
...
OUTER CARTON - PRE-FILLED PEN (pack of 2)

## 1. NAME OF THE MEDICINAL PRODUCT

Omvoh 100 mg solution for injection in pre-filled pen mirikizumab

## 2. STATEMENT OF ACTIVE SUBSTANCE(S)

Each pre-filled pen contains 100 mg of mirikizumab in 1 mL solution.
...
Multipack: 4 (2 packs of 2) pre-filled pens of 100 mg

Multipack: 6 (3 packs of 2) pre-filled pens of 100 mg
...
EU/1/23/1736/005 (4 pre-filled pens)

EU/1/23/1736/006 (6 pre-filled pens)
...
2 pre-filled pens of 100 mg. Component of a multipack, can't be sold separately.
...
## PRE-FILLED PEN LABEL 100 mg

## 1. NAME OF THE MEDICINAL PRODUCT AND ROUTE(S) OF ADMINISTRATION

Omvoh 100 mg solution for injection mirikizumab Subcutaneous use
...
OUTER CARTON - PRE-FILLED PEN (pack of 1)

## 1. NAME OF THE MEDICINAL PRODUCT

Omvoh 200 mg solution for injection in pre-filled pen mirikizumab

## 2. STATEMENT OF ACTIVE SUBSTANCE(S)

Each pre-filled pen contains 200 mg of mirikizumab in 2 mL solution.
...
Multipack: 3 (3 packs of 1) pre-filled pens of 200 mg
...
1 pre-filled pen of 200 mg. Component of a multipack, can't be sold separately.
...
1 pre-filled pen of 100 mg and 1 pre-filled pen of 200 mg
...
Multipack: 3 packs each containing 1 pre-filled pen of 100 mg and 1 pre-filled pen of 200 mg
...
This medicine contains 0.5 mg/mL of polysorbate 80 in each vial which is equivalent to 7.5 mg for the induction dose to treat ulcerative colitis and equivalent to 22.5 mg for the induction dose to treat Crohn's disease.  Polysorbates may cause allergic reactions. Tell your doctor if you have any known allergies.
...
You should not stop using Omvoh without speaking to your doctor first. If you stop treatment, symptoms of your disease may come back.
...
Do not use this medicine if you notice that the vial is damaged, or the medicine is cloudy, distinctly brown, or has particles in it.
...
Do not dilute the infusion solution with other solutions or co-infuse with other electrolytes or medications.
...
Avda. de la Industria Nº 30 28108 Alcobendas, Madrid Spain
...
6. The intravenous administration set (infusion line) should be connected to the prepared intravenous bag and the line should be primed.

For ulcerative colitis, the infusion should be administered for at least 30 minutes. For Crohn's disease, the infusion should be administered for at least 90 minutes.
...
This medicine contains 0.3 mg/mL of polysorbate 80 in each syringe which is equivalent to 0.6 mg for the maintenance dose to treat ulcerative colitis. Polysorbates may cause allergic reactions. Tell your doctor if you have any known allergies.
...
If you have forgotten to inject a dose of Omvoh, inject as soon as possible. Thereafter, resume dosing every 4 weeks.
...
Do not use this medicine after the expiry date which is stated on the label and on the outer carton after 'EXP'. The expiry date refers to the last day of that month.

Store in a refrigerator (2 °C - 8 °C). Do not freeze.

Do not microwave the syringes, run hot water over them, or leave them in direct sunlight. Do not shake your pre-filled syringe.

Omvoh may be stored unrefrigerated for up to 2 weeks at a temperature not above 30 ºC.

Store in the original packaging in order to protect from light. If these conditions are exceeded, Omvoh must be discarded.

Do not use this medicine if you notice that the pre-filled syringe is damaged, or the medicine is cloudy, distinctly brown, or has particles in it.
...
Omvoh is a solution in a clear glass cartridge encased in a disposable, single-use syringe. Its colour may vary from colourless to slightly yellow.

Omvoh is available in packs containing 2 pre-filled syringes of 100 mg and in multipacks comprising 3 cartons, each containing 2 pre-filled syringes of 100 mg.
...
Read this before you inject Omvoh. Follow all the step-by-step instructions.

- 2 Omvoh injections are required for a full dose to treat ulcerative colitis.
- Inject 1 Omvoh pre-filled syringe followed right away by the other Omvoh pre-filled syringe.

Also keep in mind:

- Your healthcare provider should show you how to prepare and inject Omvoh using the pre-filled syringe. Do not inject yourself or someone else until you have been shown how to inject Omvoh.
- Each Omvoh pre-filled syringe is for one-time use only. Do not share or reuse your syringe. You may give or get an infection.
...
- If you have vision problems, do not use Omvoh pre-filled syringe without help from a caregiver.
- Keep the Instructions for use and refer to them as needed.

<div style=\"page-break-after: always\"></div>

Before you use the Omvoh pre-filled syringes, read and carefully follow all the step-by-step instructions. Parts of the Omvoh pre-filled syringe
...
- 2 injections are required for a full dose to treat ulcerative colitis.
- Inject one syringe followed right away by the other syringe.
...
Do not use the syringe, and dispose of as directed by your healthcare provider if:

- it looks damaged
- the medicine is cloudy, is discoloured, or has particles
- the expiry date printed on the label has passed
- the medicine is frozen

Wash your hands with soap and water before you inject Omvoh.

Your healthcare provider can help you choose the injection site that is best for you.

- You or another person may inject the medicine into your stomach area (abdomen). Do not inject within 5 centimetres of the belly button (navel).
- You or another person may inject the medicine in the front of your thighs. This area should be at least 5 centimetres above the knee and 5 centimetres below the groin.
- Another person may give you the injection in the back of your upper arm.
- Do not inject in the exact same spot every time. For example, if your first injection was in your abdomen, your second injection - to complete a full dose - could be in another spot in your abdomen.
- Do not inject into areas where the skin is tender, bruised, red or hard.

Clean the injection site with an alcohol wipe. Let the injection site dry before you inject your medicine.
...
- Pull the needle cap off and throw it away in your household waste.
...
2 injections are required for a full dose. Inject one syringe immediately followed by the other syringe.
...
## Disposing of Omvoh syringe

## Throw away the used syringe

- Put the used syringe in a sharps disposal container right away after use. Do not throw the syringe directly into your household waste.
...
- For more information on how to dispose of the container properly, ask your healthcare provider about options available in your area.

<!-- image -->

## Commonly asked questions

## Q. What if I let my syringe warm up for longer than 30 minutes before injecting?

A. Your syringe can stay at room temperature up to 30 °C for up to 2 weeks.

## Q. What if I see air bubbles in the syringe?

A. It is normal to have air bubbles in the syringe. They will not harm you or affect your dose.
...
- Do not use the syringe. Talk to your doctor or pharmacist to get a new one.
...
Do not microwave the syringe, run hot water over it, or leave it in direct sunlight. Do not shake your pre-filled syringe.
...
Omvoh is available in packs containing 1 pre-filled syringe of 200 mg and in multipacks comprising 3 cartons, each containing 1 pre-filled syringe of 200 mg. Not all pack sizes may be marketed.
...
- Your healthcare provider should show you how to prepare and inject Omvoh using the pre-filled syringe. Do not inject yourself or someone else until you have been shown how to inject Omvoh.
- The pre-filled syringe contains 1 dose of Omvoh. The Omvoh pre-filled syringe is for one-time use only. Do not share or reuse your syringe. You may give or get an infection.
- Your healthcare provider may help you decide where on your body to inject your dose. You can also read the 'Choose your injection site' section of these instructions to help you choose which area can work best for you.
- If you have vision problems, do not use Omvoh pre-filled syringe without help from a caregiver.
- Keep the Instructions for use and refer to them as needed.

Before you use the Omvoh syringe, read and carefully follow all the step-by-step instructions.
...
## Q. What if I let my syringe warm up for longer than 45 minutes before injecting?
...
## Omvoh 100 mg solution for injection in pre-filled syringe Omvoh 200 mg solution for injection in pre-filled syringe
...
This medicine contains 0.3 mg/mL of polysorbate 80 in each syringe which is equivalent to 0.9 mg for the maintenance dose to treat Crohn's disease.  Polysorbates may cause allergic reactions. Tell your doctor if you have any known allergies.
...
- Treatment start: The first dose of Omvoh is 900 mg (3 vials of 300 mg each) and will be given by your doctor by intravenous infusion (drip in a vein in your arm) over at least 90 minutes. After the first dose, you will receive another dose of Omvoh 900 mg 4 weeks later and again after an additional 4 weeks.
...
Store in the original packaging in order to protect from light. Omvoh may be stored unrefrigerated for up to 2 weeks at a temperature not above 30 ºC. If these conditions are exceeded, Omvoh must be discarded.
...
Omvoh is available in packs containing 2 pre-filled syringes and in multipacks comprising 3 cartons, each containing 2 pre-filled syringes. Not all pack sizes may be marketed.
...
- 2 Omvoh injections are required for a full dose to treat Crohn's disease: one syringe with 100 mg and one syringe with 200 mg.
- Inject one Omvoh pre-filled syringe followed right away by the other Omvoh pre-filled syringe.
...
## Before you use the Omvoh syringes, read and carefully follow all the step-by-step instructions.

## 2 syringes = full 300 mg dose

After your first injection, choose a new injection site at least 5 centimeters away and clean it. With your second syringe , repeat steps 1-3 immediately after your first injection. You must inject 2 syringes to complete your full 300 mg dose.

<div style=\"page-break-after: always\"></div>

## Parts of the Omvoh pre-filled syringe

Inject both syringes in any order for a full 300 mg dose. The 200 mg syringe is larger than the 100 mg syringe.

<!-- image -->

## Bottom

100 mg + 200 mg = 1 Full dose

## IMPORTANT:

- 2 injections are required for a full dose to treat Crohn's disease: one syringe with 100 mg and one syringe with 200 mg.
- Inject one syringe followed right away by the other syringe.
...
This medicine contains 0.3 mg/mL of polysorbate 80 in each pen which is equivalent to 0.6 mg for the maintenance dose to treat ulcerative colitis.  Polysorbates may cause allergic reactions. Tell your doctor if you have any known allergies.
...
Do not microwave the pens, run hot water over them, or leave them in direct sunlight. Do not shake your pre-filled pen.

Store in the original packaging in order to protect from light. Omvoh may be stored unrefrigerated for up to 2 weeks at a temperature not above 30 ºC. If these conditions are exceeded, Omvoh must be discarded.

<div style=\"page-break-after: always\"></div>

Do not use this medicine if you notice that the pre-filled pen is damaged, or the medicine is cloudy, distinctly brown, or has particles in it.
...
Omvoh is a solution in a clear glass cartridge encased in a disposable, single-use pen. Its colour may vary from colourless to slightly yellow.

Omvoh is available in packs containing 2 pre-filled pens of 100 mg, in multipacks comprising 2 cartons, each containing 2 pre-filled pens of 100 mg and in multipacks comprising 3 cartons, each containing 2 pre-filled pens of 100 mg. Not all pack sizes may be marketed.
...
## Instructions for use Omvoh 100 mg solution for injection in pre-filled pen

## mirikizumab

2 pre-filled pens: 1 pen 100 mg and 1 pen 100 mg
...
- 2 Omvoh injections are required for a full dose to treat ulcerative colitis.
- Inject 1 Omvoh pen followed right away by the other Omvoh pen.

## Also keep in mind:

- Your healthcare provider should show you how to prepare and inject Omvoh using the pen. Do not inject yourself or someone else until you have been shown how to inject Omvoh.
- Each Omvoh pen is for one-time use only. Do not share or reuse your pen. You may give or get an infection.
- Your healthcare provider may help you decide where on your body to inject your dose. You can also read the 'Choose your injection site' section of these instructions to help you choose which area can work best for you.
- If you have vision or hearing problems, do not use Omvoh pen without help from a caregiver.
- Keep the Instructions for use and refer to them as needed.

<div style=\"page-break-after: always\"></div>

## Before you use the Omvoh pens, read and carefully follow all the step-by-step instructions. Parts of the Omvoh pen
...
- 2 injections are required for a full dose to treat ulcerative colitis.
- Inject 1 pen followed right away by the other pen.
...
Do not microwave the pens, run hot water over them, or leave them in direct sunlight.
...
Do not use the pens, and dispose of as directed by your healthcare provider if:
...
- Keep holding the clear base firmly against your skin. You will hear a second loud click in about 10 seconds after the first one (injection completed).
...
- Put the used pen in a sharps disposal container right away after use. Do not throw the pen directly into your household waste.
- If you do not have a sharps disposal container, you may use a household container that is:
- made of a heavy-duty plastic,
- can be closed with a tight fitting, puncture-resistant lid, without sharps being able to come out,
- upright and stable during use,
- leak-resistant,
- properly labelled to warn of hazardous waste inside the container.
- When your sharps disposal container is almost full, you will need to follow your community guidelines for the right way to dispose of your sharps disposal container. There may be local laws about how you should throw away needles and pens.
- Do not recycle your used sharps disposal container.
- For more information on how to dispose of the container properly, ask your healthcare provider about options available in your area.
...
## Q. What if I let my pens warm up for longer than 30 minutes before injecting?
...
- A. You do not need to hold the blue injection button down, but it may help you keep the pen steady and firm against your skin.
...
- A. After you press the blue injection button, you will hear 2 loud clicks. The second loud click tells you that your injection is complete. You will also see the grey plunger at the top of the clear base.
...
Do not microwave the pen, run hot water over it, or leave it in direct sunlight. Do not shake your pre-filled pen.
...
Omvoh is available in packs containing 1 pre-filled pen of 200 mg and in multipacks comprising 3 cartons, each containing 1 pre-filled pen of 200 mg. Not all pack sizes may be marketed.
...
- Your healthcare provider should show you how to prepare and inject Omvoh using the pen. Do not inject yourself or someone else until you have been shown how to inject Omvoh.
- The pre-filled pen contains 1 dose of Omvoh. The Omvoh pen is for one-time use only. Do not share or reuse your pen. You may give or get an infection.
- Your healthcare provider may help you decide where on your body to inject your dose. You can also read the 'Choose your injection site' section of these instructions to help you choose which area can work best for you.
- If you have vision or hearing problems, do not use Omvoh pen without help from a caregiver.
- Keep the Instructions for use and refer to them as needed.

Before you use the Omvoh pens, read and carefully follow all the step-by-step instructions.
...
Do not use the pen, and dispose of as directed by your healthcare provider if:
...
- Press and hold the blue injection button. You will hear a loud click (injection started).
- Keep holding the clear base firmly against your skin. You will hear a second loud click in about 15 seconds after the first one (injection completed).
- You will know the injection is complete when the grey plunger is visible.
- Remove the pen from your skin.
- If you have bleeding at the injection site, press a cotton ball or gauze over the injection site.
- Do not rub the injection site.
...
This medicine contains 0.3 mg/mL of polysorbate 80 in each pen which is equivalent to 0.9 mg for the maintenance dose to treat Crohn's disease.  Polysorbates may cause allergic reactions. Tell your doctor if you have any known allergies.
...
Omvoh is available in pack containing 2 pre-filled pens and in multipacks comprising 3 cartons, each containing 2 pre-filled pens.
...
- 2 Omvoh injections are required for a full dose to treat Crohn's disease: one pen with 100 mg and one pen with 200 mg.
- Inject one Omvoh pen followed right away by the other Omvoh pen.
...
## 2 Pens = full 300 mg dose

After your first injection, choose a new injection site at least 5 centimeters away and clean it. With your second Pen , repeat steps 1-3 immediately after your first injection. You must inject 2 Pens to complete your full 300 mg dose.

<div style=\"page-break-after: always\"></div>

## Parts of the Omvoh pen

Inject both Pens in any order for a full 300 mg dose. The 200 mg Pen is larger than the 100 mg Pen.
...
- 2 injections are required for a full dose to treat Crohn's disease: one pen with 100 mg and one pen with 200 mg.
- Inject one pen followed right away by the other pen.
...
Leave the pens at room temperature for 45 minutes before injecting.
