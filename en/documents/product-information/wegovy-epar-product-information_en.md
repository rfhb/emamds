---
document_datetime: 2026-09-21 11:26:08
document_pages: 182
...
version: success
processing_time: 305.8074286
conversion_datetime: 2026-09-25 19:35:12.906642
docling_version:
...
Table 1 BMI cut-off points for obesity (≥95 th percentile) by gender and age for paediatric patients aged 12 and older (CDC criteria)

|   Age (years) |   BMI (kg/m 2 ) at 95 th Percentile - Males |   BMI (kg/m 2 ) at 95 th Percentile - Females |
|---------------|---------------------------------------------|-----------------------------------------------|
|            12 |                                        24.2 |                                          25.2 |
|          12.5 |                                        24.7 |                                          25.7 |
|            13 |                                        25.1 |                                          26.3 |
...
If needed, the dose can be increased to 7.2 mg once weekly after a minimum of 4 weeks on the 2.4 mg dose in adults with BMI ≥ 30 kg/m 2 at treatment initiation.
...
- aged 85 years or more (see section 4.2), - with mild or moderate hepatic impairment (see section 4.2), - with inflammatory bowel disease.
...
Semaglutide delays gastric emptying and could potentially influence the absorption of concomitantly administered oral medicinal products. No clinically relevant effect on the rate of gastric emptying was observed with semaglutide 2.4 mg, probably due to a tolerance effect. The effect of semaglutide 7.2 mg on the rate of gastric emptying has not been investigated. Semaglutide should be used with caution in patients receiving oral medicinal products that require rapid gastrointestinal absorption.
...
In STEP-UP, dysaesthesia-related events were reported by 21.6% of patients treated with semaglutide 7.2 mg and 0.3% of patients on placebo. Most events in the 7.2 mg group were mild to moderate and 85% (368 out of 434 events) recovered while on treatment. 28% (123 of all 434 events) in the semaglutide 7.2 mg s.c. group recovered after changes in the dose of the trial product.
...
| Change (%) from baseline 1,2              | -14.9                 | -2.4      |
| Difference (%) from placebo 1 [95% CI]    | -12.4 [-13.4; -11.5]* | -         |
| Change (kg) from baseline                 | -15.3                 | -2.6      |
| Difference (kg) from placebo 1 [95% CI]   | -12.7 [-13.7; -11.7]  | -         |
...
| Change (%) from baseline 1,2              | -16.0                | -5.7      |
| Difference (%) from placebo 1 [95% CI]    | -10.3 [-12.0;-8.6]*  | -         |
| Change (kg) from baseline                 | -16.8                | -6.2      |
| Difference (kg) from placebo 1 [95% CI]   | -10.6 [-12.5;-8.8]   | -         |
...
| Body weight                             |                       |           |
| Baseline 1 (kg)                         | 96.5                  | 95.4      |
| Change (%) from baseline 1,2,3          | -7.9                  | 6.9       |
| Difference (%) from placebo 2 [95% CI]  | -14.8 [-16.0; -13.5]* | -         |
| Change (kg) from baseline               | -7.1                  | 6.1       |
| Difference (kg) from placebo 2 [95% CI] | -13.2 [-14.3; -12.0]  | -         |
| Waist circumference (cm)                |                       |           |
...
| Change from baseline 1                    | -14.4                | -5.2      |
| Difference from placebo 1 [95% CI]        | -9.2 [-12.2; -6.2]*  | -         |
| Systolic blood pressure (mmHg)            |                      |           |
| Baseline                                  | 126                  | 125       |
...
| Change (%) from baseline 1, 2               | -15.8                | -6.4               |
| Difference (%) from liraglutide 1 [95% CI]  | -9.4 [-12.0;-6.8]*   | -                  |
| Change (kg) from baseline                   | -15.3                | -6.8               |
| Difference (kg) from liraglutide 1 [95% CI] | -8.5 [-11.2;-5.7]    | -                  |
...
- -2.3% (semaglutide 2.4 mg and placebo, respectively) and for WOMAC pain score: -43.0 and -28.3 (semaglutide 2.4 mg and placebo, respectively).
...
|                                                 | STEP UP - Semaglutide 7.2 mg injection   | STEP UP - Semaglutide 2.4 mg injection   | STEP UP - Placebo         | STEP UP T2D - Semaglutide 7.2 mg injection   | STEP UP T2D - Placebo     |
|-------------------------------------------------|------------------------------------------|------------------------------------------|---------------------------|----------------------------------------------|---------------------------|
...
| Change (%) from baseline Trial product 2        | -20.7                                    | -17.5                                    | -2.4                      | -14.1                                        | -3.6                      |
| estimand Difference (%) from placebo 1 [95% CI] | -14.8 [-16.2; -13.4]*                    | -                                        | -                         | -9.3 [-11.0; -7.7]*                          | -                         |
...
| Patients (%) achieving weight loss ≥20% 3,4 | 47.7                                     | 33.3                                     | 2.9                           | 21.3                                         | 2.1                           |
| Patients (%) achieving weight loss 3,5      | 31.2                                     | 15.3                                     | 0                             | -                                            | -                             |
| ≥25% Waist circumference (cm)               | ≥25% Waist circumference (cm)            | ≥25% Waist circumference (cm)            | ≥25% Waist circumference (cm) | ≥25% Waist circumference (cm)                | ≥25% Waist circumference (cm) |
...
5 Observed on-treatment proportions achieved ≥25 % reduction in body weight among 33.2 %, 16.7 % and 0 % of patients randomised to semaglutide 7.2, 2.4 mg, and placebo, respectively in STEP UP study.
...
SELECT was a randomised, double-blind, placebo-controlled, event driven trial which included 17 604 patients with established cardiovascular disease and BMI≥27 kg/m 2 . Patients were randomised to either semaglutide 2.4 mg (n=8 803) or placebo (n=8 801) in addition to standard-of-care. The median time in trial was 41.8 months. Vital status was available for 99.4% of subjects in the trial.

The study population consisted of 27.7% female and 72.3% male patients, with a mean age of 61.6 years, including 38.2% patients ≥ 65 years (n=6 728) and 7.8% patients ≥ 75 years (n=1 366). The mean BMI was 33.3 kg/m 2 and mean body weight was 96.7 kg. Patients with history of type 1 and type 2 diabetes were excluded.
...
|                                               | STEP-HFpEF - Semaglutide 2.4 mg   | STEP-HFpEF - Placebo   | STEP-HFpEF-DM - Semaglutide 2.4 mg   | STEP-HFpEF-DM - Placebo   |
|-----------------------------------------------|-----------------------------------|------------------------|--------------------------------------|---------------------------|
...
| Patients (%) with meaningful change 4         | 47.9                              | 34.7                   | 43.8                                 | 30.6                      |
| Body weight                                   |                                   |                        |                                      |                           |
| Baseline (kg) 1                               | 108.3                             | 108.4                  | 106.4                                | 105.2                     |
| Change (%) from baseline 2                    | -13.3                             | -2.6                   | -9.8                                 | -3.4                      |
| Difference (%) from placebo 2 [95% CI]        | -10.7 [-11.9; -9.4]               | -10.7 [-11.9; -9.4]    | -6.4 [-7.6; -5.2]                    | -6.4 [-7.6; -5.2]         |
...
Table 13 STEP TEENS: Results at week 68
...
| Change (%) from baseline 1,2              | -16.1                  | 0.6       |
| Difference (%) from placebo 1 [95% CI]    | -16.7 [-20.3; -13.2] * | -         |
| Baseline (BMI SDS)                        | 3.4                    | 3.1       |
| Change from baseline in BMI SDS 1         | -1.1                   | -0.1      |
| Difference from placebo 1 [95% CI]        | -1.0 [-1.3; -0.8]      | -         |
| Body Weight                               |                        |           |
| Baseline (kg)                             | 109.9                  | 102.6     |
| Change (%) from baseline 1                | -14.7                  | 2.8       |
| Difference (%) from placebo 1 [95% CI]    | -17.4 [-21.1; -13.8]   | -         |
| Change (kg) from baseline 1               | -15.3                  | 2.4       |
| Difference (kg) from placebo 1 [95% CI]   | -17.7 [-21.8; -13.7]   | -         |
...
Figure 10 STEP TEENS: Mean change in BMI (%) from baseline to week 68
...
Body weight had an effect on the exposure of semaglutide. Higher body weight was associated with lower exposure; a 20% difference in body weight between individuals will result in an approximate 18% difference in exposure. The 2.4 mg and 7.2 mg weekly dose of semaglutide provided adequate systemic exposures over the body weight range of 54.4-251.2 kg evaluated for exposure response in the clinical trials.
...
Pre-filled pen, FlexTouch Disodium phosphate, dihydrate Propylene glycol Phenol Hydrochloric acid (for pH adjustment) Sodium hydroxide (for pH adjustment)
...
Wegovy 1 mg solution for injection Wegovy 1.7 mg solution for injection
...
Wegovy 0.25 mg solution for injection in pre-filled pen semaglutide
...
Wegovy 0.25 mg injection semaglutide
...
Wegovy 0.5 mg solution for injection in pre-filled pen semaglutide
...
Store in a refrigerator. Do not freeze Discard pen after use
...
Wegovy 0.5 mg injection semaglutide
...
Wegovy 1 mg solution for injection in pre-filled pen semaglutide
...
Wegovy 1.7 mg solution for injection in pre-filled pen semaglutide
...
Wegovy 1.7 mg injection semaglutide
...
Each pre-filled pen contains 2.4 mg semaglutide in 0.75 mL (3.2 mg/mL)
...
Wegovy 2.4 mg injection semaglutide
...
Wegovy 0.25 mg FlexTouch solution for injection in pre-filled pen semaglutide
...
Excipients: disodium phosphate dihydrate, propylene glycol, phenol, hydrochloric acid/sodium hydroxide (for pH adjustment), water for injections. See leaflet for further information

## 4. PHARMACEUTICAL FORM AND CONTENTS

solution for injection

1 x1.5 mL pen and 4 disposable needles (1 pen = 4 doses)
...
Wegovy 0.25 mg injection FlexTouch semaglutide
...
Wegovy 0.5 mg FlexTouch solution for injection in pre-filled pen semaglutide

## 2. STATEMENT OF ACTIVE SUBSTANCE

Each pre-filled pen contains 2 mg semaglutide in 1.5 mL (1.34 mg/mL)
...
Wegovy 0.5 mg injection FlexTouch semaglutide
...
Each pre-filled pen contains 2 mg semaglutide in 3 mL (0.68 mg/mL)
...
1 x3 mL pen and 4 disposable needles (1 pen = 4 doses)
...
Wegovy 0.5 mg injection FlexTouch semaglutide SC
...
Wegovy 1 mg FlexTouch solution for injection in pre-filled pen semaglutide
...
Wegovy 1 mg injection FlexTouch semaglutide
...
Wegovy 1.7 mg FlexTouch solution for injection in pre-filled pen semaglutide
...
Wegovy 1.7 mg injection FlexTouch semaglutide
...
Wegovy 2.4 mg FlexTouch solution for injection in pre-filled pen semaglutide
...
3 x3 mL pens and 12 disposable needles (1 pen = 4 doses)
...
EU/1/21/1608/010 1 pen and 4 disposable needles

EU/1/21/1608/011 3 pens and 12 disposable needles
...
Wegovy 2.4 mg injection FlexTouch semaglutide
...
Store in a refrigerator. Do not freeze Discard pre-filled syringe after use
...
Oral use Read the package leaflet before use How to take Wegovy Take on an empty stomach, after a recommended fasting of at least 8 hours Take the tablet whole with a sip of water (up to 120 mL). Do not split, crush, or chew
...
EU/1/21/1608/019 10 tablets EU/1/21/1608/020 30 tablets
...
EU/1/21/1608/022 10 tablets EU/1/21/1608/023 30 tablets EU/1/21/1608/024 90 tablets
...
Wegovy 1 mg solution for injection in pre-filled pen Wegovy 1.7 mg solution for injection in pre-filled pen
...
For Wegovy 7.2 mg inject three doses of 2.4 mg one after each other. The injections can be given in the same body area but should be at least 5 cm apart.
...
Wegovy 2.4 mg FlexTouch solution for injection in pre-filled pen Each pre-filled pen contains 9.6 mg semaglutide in 3 mL (3.2 mg/mL).
...
## Instructions on how to use Wegovy
...
Wegovy pen is a dial-a-dose pen that contains four of your doses of Wegovy.

Please use the table inside the lid of the carton to keep track of how many injections you have used and how many doses remain in your pen.

Wegovy comes in five different pen variants, each containing one of the following prescribed doses of semaglutide:
...
Take a needle when you are ready to take your injection. Check the paper tab and the outer needle cap for damages that could affect sterility. If any damage is seen, use a new needle.
...
If your Wegovy pen is already in use, go to '2 Set your dose'.
...
Press and hold in the dose button until the dose counter returns to . The must line up with the dose pointer.
...
Choose your upper arms, upper legs or stomach (keep a 5 cm distance from your belly button).

You may inject in the same body area, but make sure it is not in the same spot as used the last time.
...
Press and hold down the dose button until the dose counter shows .

(See figure M).

Keep pressing the dose button with the needle in your skin and slowly count to 6. The must line up with the dose pointer. You may hear or feel a click when the dose counter returns to .
...
- If does not appear in the dose counter after continuously pressing the dose button, you may have used a blocked or damaged needle.
- In this case, you have not received any Wegovy - even though the dose counter has moved from the original dose that you have set.

## How to handle a blocked needle

- Change the needle as instructed in '1 Prepare your pen with a new needle' and go to '2 Set your dose'.
...
- See the back of this leaflet to read the storage conditions for your pen.
- Do not inject Wegovy that has been exposed to direct sunlight.
- Do not subject Wegovy to frost and never inject Wegovy that has been frozen. Dispose of the pen.
...
If the dose counter stops before you reach your prescribed dose, there is not enough Wegovy left for a full dose. Dispose of the pen and use a new Wegovy pen.

## Important information

- Only use Wegovy once weekly as prescribed. If you do not use your Wegovy as prescribed, you may not get the intended effect of this medicine.
...
Wegovy 0.5 mg solution for injection in pre-filled syringe Wegovy 1 mg solution for injection in pre-filled syringe Wegovy 1.7 mg solution for injection in pre-filled syringe Wegovy 2.4 mg solution for injection in pre-filled syringe
...
- The active substance is semaglutide. Wegovy 0.25 mg solution for injection Each pre-filled syringe contains 0.25 mg semaglutide in 0.5 mL (0.5 mg/mL).

Wegovy 0.5 mg solution for injection Each pre-filled syringe contains 0.5 mg semaglutide in 0.5 mL (1 mg/mL).

Wegovy 1 mg solution for injection Each pre-filled syringe contains 1 mg semaglutide in 0.5 mL (2 mg/mL).
