...
- [News on Ahzantive](#news-on)
- [Related document](#related-document-71419)
...
Ahzantive contains the active substance aflibercept and is a 'biosimilar medicine'; this means that Ahzantive is highly similar to another biological medicine (the 'reference medicine') that is already authorised in the EU. The reference medicine for Ahzantive is Eylea. For more information on biosimilar medicines, see [here](https://www.ema.europa.eu/en/human-regulatory/overview/biosimilar-medicines) .
...
Ahzantive is given as an injection into the affected eye, repeated as appropriate at intervals of a month or more. How often the injections are given depends on the condition being treated and the response of the patient to treatment.
...
In addition, a study involving 434 patients with wet AMD showed that Ahzantive was as effective as Eylea. In this study, the average number of letters patients could recognise on a standard eye test improved by around 7 letters in the Ahzantive group and 6 letters in the Eylea group after 8 weeks of treatment.
...
For the complete list of side effects and restrictions of Ahzantive, see the package leaflet.
...
Recommendations and precautions to be followed by healthcare professionals and patients for the safe and effective use of Ahzantive have also been included in the summary of product characteristics and the package leaflet.
...
Ahzantive : EPAR - Medicine overview

Reference Number: EMA/552094/2024
...
Ahzantive : EPAR - Risk management plan

English (EN) (610.24 KB - PDF)

**First published:** 24/01/2025

[View](/en/documents/rmp/ahzantive-epar-risk-management-plan_en.pdf)
...
Ahzantive : EPAR - All authorised presentations
...
[View](/en/documents/assessment-report/ahzantive-epar-public-assessment-report_en.pdf)
