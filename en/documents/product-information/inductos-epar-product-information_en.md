---
document_datetime: 2023-09-21 20:42:28
document_pages: 44
document_pathfilename: www.ema.europa.eu/en/documents/product-information/inductos-epar-product-information_en.pdf
document_name: inductos-epar-product-information_en.pdf
version: success
processing_time: 10.0731085
conversion_datetime: 2025-12-28 04:46:32.505155
docling_version:
  docling-serve: 1.9.0
...
|----------------------------------------|-------------------------------|---------------------------|----------------------------------|------------------------|
| 1 matrix                               | 2.5 cm x 5 cm                 | 1.3 cm 3                  | 1.5 mg/cm 3                      | 2 mg                   |
| 2 matrices                             | 2 x (2.5 cm x 5 cm)           | 2.7 cm 3                  | 1.5 mg/cm 3                      | 4 mg                   |
...
In clinical trials when degenerative disc disease was treated by a posterior lumbar interbody fusion procedure with dibotermin alfa, posterior bone formation was observed in CT scans. In some cases it

<div style=\"page-break-after: always\"></div>

may lead to nerve compression potentially requiring surgical intervention (see section 4.8). As a precaution, a physical barrier between the matrix and any neurological tissue must be re-created (see section 4.2).
...
|------------------------------------------------------|-------------------------|---------------------------------------------|----------------------------------------|
|                                                      | Very common             | Common                                      | Unknown                                |
| General disorders and administration site conditions |                         | Device dislocation 1 * Fluid collection 2 * |                                        |
| Musculoskeletal and connective tissue disorders      |                         | Heterotopic ossification 1, 3 *             | Osteolysis* Resorption bone increased* |
| Nervous system disorders                             |                         | Radiculopathic events 1, 4                  |                                        |
| Infections and infestations                          | Localised infection 5 * |                                             |                                        |
...
Powder: Sucrose Glycine Glutamic acid Sodium chloride Polysorbate 80 Sodium hydroxide
...
6422 PJ Heerlen The Netherlands tel +31 (0) 45 566 8000
...
Additional educational materials for healthcare professionals are available on the following URL: [URL to be included] &lt;and the &lt;Member State&gt; website&gt;.

<div style=\"page-break-after: always\"></div>

## ANNEX II

- A. MANUFACTURER OF THE BIOLOGICAL ACTIVE SUBSTANCE AND MANUFACTURER RESPONSIBLE FOR BATCH RELEASE B. CONDITIONS OR RESTRICTIONS REGARDING SUPPLY AND USE C. OTHER CONDITIONS AND REQUIREMENTS OF THE MARKETING AUTHORISATION CONDITIONS OR RESTRICTIONS WITH REGARD TO THE SAFE AND
...
Wyeth BioPharma Division of Wyeth Pharmaceuticals LLC One Burtt Road Andover Massachusetts 01810 USA

Name and address of the manufacturer responsible for batch release

Medtronic BioPharma B.V. Earl Bakkenstraat 10 6422 PJ Heerlen The Netherlands
...
One vial contains 4 mg dibotermin alfa . When reconstituted, InductOs contains 1.5 mg/ml dibotermin alfa.
...
Powder, solvent and matrix for implantation matrix contain:

- 1 vial with 4 mg dibotermin alfa
- 1 vial with 10 ml water for injections
- 2 sterile matrices (2.5 x 5 cm)
- 2 syringes (5 ml)
- 2 needles

## 5. METHOD AND ROUTE(S) OF ADMINISTRATION

Implantation. Read the Summary of Product Characteristics before use.
...
## TRAY TOP LID LABEL FOR 4 MG PACK
...
One vial contains 4 mg dibotermin alfa. When reconstituted, contains 1.5 mg/ml dibotermin alfa.
...
Do not store above 30 ° C. Do not freeze. Store in original package in order to protect from light.
...
Medtronic BioPharma B.V. Earl Bakkenstraat 10 6422 PJ Heerlen
...
## PARTICULARS TO APPEAR ON THE IMMEDIATE PACKAGING TRAY UNDERSIDE OF LID STICKER FOR 4 MG PACK
...
## VIAL PROTEIN LABEL FOR 4 MG PACK

1.

NAME OF THE MEDICINAL PRODUCT AND ROUTE(S) OF ADMINISTRATION

Powder for InductOs 1.5 mg/ml dibotermin alfa Implantation

## 2. METHOD OF ADMINISTRATION

Read the Summary of Product Characteristics before use.
...
|-------------------------------------------------------------------|
| VIAL SOLVENT LABEL FOR 4 MGPACK                                   |

| 1.   | NAME OF THE MEDICINAL PRODUCT AND ROUTE(S) OF ADMINISTRATION   |
|------|----------------------------------------------------------------|

Solvent for InductOs Water for injections
...
| 5.   | CONTENTSBYWEIGHT,BYVOLUMEOR BY UNIT   |
|------|---------------------------------------|
...
## MATRIX LABEL FOR 4 MG PACK

## 1. NAME OF THE MEDICINAL PRODUCT

Matrix for InductOs 1.5 mg/ml Bovine Type I collagen
...
One vial contains 12 mg dibotermin alfa . When reconstituted, InductOs contains 1.5 mg/ml dibotermin alfa.
...
- 1 vial with12 mg dibotermin alfa
- 1 vial with 10 ml water for injections
...
## TRAY TOP LID LABEL FOR 12 MG PACK
...
One vial contains 12 mg dibotermin alfa. When reconstituted, contains 1.5 mg/ml dibotermin alfa.
...
- 1 vial with 12 mg dibotermin alfa
- 1 vial with 10 ml water for injections
- 1 sterile matrix (7.5 x 10 cm)
- 2 syringes (10 ml)
- 2 needles
...
## VIAL PROTEIN LABEL FOR 12 MG PACK
...
| MINIMUM PARTICULARS TO APPEARON SMALL IMMEDIATE PACKAGING UNITS   |
|-------------------------------------------------------------------|
| VIAL SOLVENT LABEL FOR 12 MGPACK                                  |
...
- Some patients may develop nerve pain due to localised fluid collection, which would require drainage or a surgical procedure to remove the fluid.
- Some patients may develop antibodies (made by your body to fight a foreign protein) to InductOs.  While no harmful effects have been noted, the long-term effects are unknown.
- You should inform your doctor if you have kidney or liver disease.
- Localised swelling, in some cases resulting in breathing difficulty, has been reported in patients when InductOs has been used in surgery of the upper (neck) region of the spine. The safety and effectiveness of InductOs in spine surgery in the neck have not been established, and InductOs should not be used in this situation.
...
- Common (may affect up to 1 in 10 people): Additional bone growth, movement of the implanted medical device, localised fluid build-up and pain radiating from your back to your leg (sciatica)
- Unknown (cannot be estimated from available data): Increased breakdown of the bone

## Fractures of the shin bone

Talk to your doctor if you have any of the following:

- Very common (may affect more than 1 in 10 people): Localised infection
...
- -The active substance in InductOs is dibotermin alfa (also called recombinant human Bone Morphogenetic Protein-2), 4 mg (4 mg pack) or 12 mg (12 mg pack).
