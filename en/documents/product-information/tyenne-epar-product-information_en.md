...
Clear and colourless to pale yellow solution with a pH of 5.7-6.3 and an osmolality of 200300 mOsm/kg.
...
Tyenne is supplied in a vial (type I glass) with a stopper (bromobutyl rubber) containing 4 mL, 10 mL or 20 mL concentrate. Each pack contains 1 or 4 vials.
...
Clear and colourless to pale yellow solution with a pH of 5.7-6.3 and an osmolality of 260 320 mOsm/kg.
...
Comprehensive instructions for the administration of Tyenne in a pre-filled syringe are given in the package leaflet, see section 6.6.
...
Following subcutaneous dosing in GCA patients, the absorption t1/2 was around 4 days. The bioavailability for the subcutaneous formulation was 0.8. The median values of Tmax were 3 days after the tocilizumab weekly dose and 4.5 days after the tocilizumab every other week dose.
...
Each 162 mg/0.9 mL pen contains 0.18 mg (0.2 mg/mL) polysorbate 80.
...
Pre-filled syringes can be stored for a single period of up to 14 days at or below 30 °C.
...
Since Tyenne is given by a doctor or nurse, it is unlikely that you will be given too much. However, if you are worried, talk to your doctor.
...
Tyenne is a concentrate for solution for infusion. The concentrate is a clear and colourless to pale yellow liquid.

Tyenne is supplied as vials containing 4 mL, 10 mL and 20 mL concentrate for solution for infusion. Each pack contains 1 or 4 vials. Not all pack sizes may be marketed.
...
## Read these Instructions for Use before using your Tyenne pre-filled syringe and each time you get a prescription refill.
...
- Store the pre-filled syringe in its original carton in a refrigerator between 2 °C and 8 °C.
...
- Tyenne pre-filled syringe is for single-dose (one-time) use only.
...
- Tyenne pre-filled syringe has a clear needle guard that covers the needle after the injection is complete.
...
- Hold the pre-filled syringe by the clear needle guard in one hand ( Figure O ).
- Use your other hand to remove the needle cap by pulling the cap straight off ( Figure O ).
...
- With a quick, short motion, insert the needle all the way into the pinched skin at an angle between 45° to 90° ( Figure Q ). Give the injection at the angle your doctor instructed you to use.
...
- Keep pressing down on the plunger to deliver the full dose until you cannot press any more ( Figure S ).
...
Tyenne pre-filled pen is not recommended for use in children under 12 years of age. Tyenne must not be given to children with sJIA (systemic juvenile idiopathic arthritis) weighing less than 10 kg.
...
Because Tyenne is given in one pre-filled pen, it is unlikely that you will receive too much. However, if you are worried, talk to your doctor, pharmacist or nurse.
