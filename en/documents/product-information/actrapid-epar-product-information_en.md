---
document_datetime: 2023-09-21 20:11:20
document_pages: 89
document_pathfilename: www.ema.europa.eu/en/documents/product-information/actrapid-epar-product-information_en.pdf
document_name: actrapid-epar-product-information_en.pdf
version: success
processing_time: 18.2606259
conversion_datetime: 2025-12-29 19:40:10.697291
docling_version:
  docling-serve: 1.9.0
...
## Actrapid vial (40 international units/ml)/Actrapid vial (100 international units/ml) Intravenous use
...
| Eye disorders                                        | Very rare - Diabetic retinopathy                      |
...
Pharmacotherapeutic group: Drugs used in diabetes. Insulins and analogues for injection, fast-acting, insulin (human). ATC code: A10AB01.
...
Actrapid Penfill EU/1/02/230/005 EU/1/02/230/006

<div style=\"page-break-after: always\"></div>

EU/1/02/230/007

Actrapid InnoLet EU/1/02/230/010 EU/1/02/230/011 EU/1/02/230/012

Actrapid FlexPen EU/1/02/230/013 EU/1/02/230/014 EU/1/02/230/015
...
Actrapid 40 IU/ml Solution for injection insulin human
...
Subcutaneous or intravenous use Read the package leaflet before use
...
Actrapid 40 IU/ml Solution for injection insulin human SC, IV
...
Actrapid 100 IU/ml Solution for injection insulin human
...
EU/1/02/230/003   1 vial of 10 ml

EU/1/02/230/004   5 vials of 10 ml
...
Actrapid 100 IU/ml Solution for injection insulin human SC, IV
...
EU/1/02/230/016   5 packs of 1 x 10 ml vial
...
EU/1/02/230/017   5 packs of 1 x 10 ml vial
...
Actrapid Penfill 100 IU/ml Solution for injection in cartridge insulin human
...
EU/1/02/230/006   5 cartridges of 3 ml

EU/1/02/230/007   10 cartridges of 3 ml
...
Actrapid Penfill 100 IU/ml Solution for injection insulin human SC
...
Actrapid InnoLet 100 IU/ml insulin human
...
Actrapid InnoLet 100 IU/ml Solution for injection insulin human SC
...
Actrapid FlexPen 100 IU/ml insulin human
...
EU/1/02/230/014   5 pens of 3 ml

EU/1/02/230/015   10 pens of 3 ml
...
Actrapid FlexPen 100 IU/ml Solution for injection insulin human SC
...
Actrapid is presented as a solution for injection. Pack sizes of 1 or 5 vials of 10 ml or a multipack of 5 packs of 1 x 10 ml vial. Not all pack sizes may be marketed.
...
## Actrapid 100 IU/ml (international units/ml) solution

## for injection in vial human insulin
...
## Actrapid Penfill 100 IU/ml (international units/ml) solution for injection in cartridge human insulin
...
- Actrapid Penfill is only suitable for injecting under the skin using a reusable pen. Speak to your doctor if you need to inject your insulin by another method.
...
Skin changes at the injection site: If you inject insulin at the same place, the fatty tissue may shrink (lipoatrophy) or thicken (lipohypertrophy) (may affect less than 1 in 100 people). Lumps under the skin may also be caused by build-up of a protein called amyloid (cutaneous amyloidosis; how often

<div style=\"page-break-after: always\"></div>

this occurs is not known). The insulin may not work very well if you inject into a lumpy, shrunken or thickened area. Change the injection site with each injection to help prevent these skin changes.
...
Actrapid is presented as a solution for injection. Pack sizes of 1, 5 and 10 cartridges of 3 ml. Not all pack sizes may be marketed.
...
## Actrapid InnoLet 100 IU/ml (international units/ml) solution for injection in pre-filled pen human insulin
...
- Actrapid InnoLet is only suitable for injecting under the skin. Speak to your doctor if you need to inject your insulin by another method.
...
- -The active substance is human insulin. Each ml contains 100 IU of human insulin. Each prefilled pen contains 300 IU of human insulin in 3 ml solution for injection.
- -The other ingredients are zinc chloride, glycerol, metacresol, sodium hydroxide, hydrochloric acid and water for injections.

## What Actrapid looks like and contents of the pack

Actrapid is presented as a solution for injection. Pack sizes of 1, 5 and 10 pre-filled pens of 3 ml. Not all pack sizes may be marketed.
...
## Instructions on how to use Actrapid solution for injection in InnoLet
...
- outer needle cap in the compartment. Never try to put the inner needle cap back on the needle. You may stick yourself with the needle.
...
## Actrapid FlexPen 100 IU/ml (international units/ml) solution for injection in pre-filled pen human insulin
...
- Actrapid FlexPen is only suitable for injecting under the skin. Speak to your doctor if you need to inject your insulin by another method.
...
Actrapid is administered by injection under the skin (subcutaneously). You must never inject yourself directly into a vein (intravenously) or muscle (intramuscularly). Actrapid FlexPen is only suitable for injecting under the skin. Speak to your doctor if you need to inject your insulin by another method.
...
## Instructions on how to use Actrapid solution for injection in FlexPen.
...
## H Check that the dose selector is set at 0.
